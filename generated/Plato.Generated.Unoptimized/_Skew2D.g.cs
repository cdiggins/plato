...
namespace Ara3D.Geometry
{
    ...
    public partial struct Skew2D: ITransform2D
    {
        ...
        [MethodImpl(AggressiveInlining)] public bool Equals(Skew2D other) => x.Equals(other.x) && y.Equals(other.y);
        [MethodImpl(AggressiveInlining)] public bool NotEquals(Skew2D other) => !(x.Equals(other.x) && y.Equals(other.y));
        [MethodImpl(AggressiveInlining)] public override bool Equals(object obj) => obj is Skew2D other ? Equals(other) : false;
