...
namespace Ara3D.Geometry
{
    ...
    public partial struct Pose2D: IRigidTransform2D
    {
        ...
        [MethodImpl(AggressiveInlining)] public bool Equals(Pose2D other) => Translation.Equals(other.Translation) && Rotation.Equals(other.Rotation);
        [MethodImpl(AggressiveInlining)] public bool NotEquals(Pose2D other) => !(Translation.Equals(other.Translation) && Rotation.Equals(other.Rotation));
