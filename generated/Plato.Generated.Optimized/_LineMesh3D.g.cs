...
namespace Ara3D.Geometry
{
    ...
    public partial struct LineMesh3D: IIndexedGeometry3D<LineMesh3D, Integer2>
    {
        ...
        [MethodImpl(AggressiveInlining)] IReadOnlyList<Integer2> IIndexedGeometry3D<Integer2>.FaceIndices() => FaceIndices;
        ...
        [MethodImpl(AggressiveInlining)] public LineMesh3D Deform(System.Func<Point3D, Point3D> f){
            var _s11 = this.Points;
            var _n11 = _s11.Count;
            var _lp11 = new Point3D[_n11];
            for (var _i11 = 0; _i11 < _n11; _i11++)
            {
                _lp11[_i11] = f(_s11[_i11]);
            }
            return (_lp11, this.FaceIndices);
        }
        ...
        [MethodImpl(AggressiveInlining)] public LineMesh3D Transform(Transform3D t){
            var _var4 = t;
            {
                ...
                {
                    var p_24 = _s12[_i12];
                    _lp12[_i12] = new Vector3(p_24.X, p_24.Y, p_24.Z).Transform(t.Matrix);
                }
                return new LineMesh3D(_lp12, this.FaceIndices);
            }
        }
