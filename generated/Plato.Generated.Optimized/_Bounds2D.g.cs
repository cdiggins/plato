...
namespace Ara3D.Geometry
{
    ...
    public partial struct Bounds2D: IBounds<Point2D, Vector2>, IArrayLike<Bounds2D, Point2D>
    {
        ...
        [MethodImpl(AggressiveInlining)] public Point2D Center() => new Point2D(this.Min.X.Multiply(1f.Subtract(0.5f)).Add(this.Max.X.Multiply(0.5f)), this.Min.Y.Multiply(1f.Subtract(0.5f)).Add(this.Max.Y.Multiply(0.5f)));
        ...
        [MethodImpl(AggressiveInlining)] public Vector2 Size() => new Vector2(this.Max.X, this.Max.Y).Subtract(new Vector2(this.Min.X, this.Min.Y));
