...
namespace Ara3D.Geometry
{
    ...
    public partial struct Quad3D: IDeformable3D<Quad3D>, IArrayLike<Quad3D, Point3D>
    {
        ...
        [MethodImpl(AggressiveInlining)] public Point3D Center() => this.A.Add(this.B).Add(this.C).Add(this.D).Divide(4f);
        [MethodImpl(AggressiveInlining)] public IReadOnlyList<Point3D> Points() => this.Components();
        [MethodImpl(AggressiveInlining)] public Vector3 Normal(){
            var _s9a = new Triangle3D(this.A, this.B, this.C).Normal().Components();
            var _s9b = new Triangle3D(this.C, this.D, this.A).Normal().Components();
            ...
            for (var _i9 = 0; _i9 < _n9; _i9++)
            {
                var a1_22 = _s9a[_i9];
                var b1_23 = _s9b[_i9];
                _lp9[_i9] = a1_22.Multiply(1f.Subtract(0.5f)).Add(b1_23.Multiply(0.5f));
            }
            return Vector3.CreateFromComponents(_lp9).Normalize();
        }
        ...
        [MethodImpl(AggressiveInlining)] public Quad3D Transform(Transform3D t){
            var _var3 = t;
            return this.Deform((p)  => new Vector3(p.X, p.Y, p.Z).Transform(_var3.Matrix));
        }
