...
namespace Ara3D.Geometry
{
    ...
    public partial struct Triangle3D: IDeformable3D<Triangle3D>, IArrayLike<Triangle3D, Point3D>
    {
        ...
        [MethodImpl(AggressiveInlining)] public Vector3 Normal() => new Vector3(this.B.X, this.B.Y, this.B.Z).Subtract(new Vector3(this.A.X, this.A.Y, this.A.Z)).Cross(new Vector3(this.C.X, this.C.Y, this.C.Z).Subtract(new Vector3(this.A.X, this.A.Y, this.A.Z))).Normalize();
        [MethodImpl(AggressiveInlining)] public Point3D Center() => this.A.Add(this.B).Add(this.C).Divide(3f);
        [MethodImpl(AggressiveInlining)] public Plane Plane() => (new Vector3(this.B.X, this.B.Y, this.B.Z).Subtract(new Vector3(this.A.X, this.A.Y, this.A.Z)).Cross(new Vector3(this.C.X, this.C.Y, this.C.Z).Subtract(new Vector3(this.A.X, this.A.Y, this.A.Z))).Normalize(), ((float)new Vector3(this.B.X, this.B.Y, this.B.Z).Subtract(new Vector3(this.A.X, this.A.Y, this.A.Z)).Cross(new Vector3(this.C.X, this.C.Y, this.C.Z).Subtract(new Vector3(this.A.X, this.A.Y, this.A.Z))).Normalize().Dot(this.A)));
