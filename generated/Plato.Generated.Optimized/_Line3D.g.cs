...
namespace Ara3D.Geometry
{
    ...
    public partial struct Line3D: IDeformable3D<Line3D>, IInterval<Point3D>, IArrayLike<Line3D, Point3D>
    {
        ...
        [MethodImpl(AggressiveInlining)] public Vector3 Direction() => new Vector3(this.B.X, this.B.Y, this.B.Z).Subtract(new Vector3(this.A.X, this.A.Y, this.A.Z));
        ...
        [MethodImpl(AggressiveInlining)] public Point3D Start() => this.A;
        [MethodImpl(AggressiveInlining)] public Point3D End() => this.B;
        [MethodImpl(AggressiveInlining)] public Point3D Center() => new Point3D(this.A.X.Multiply(1f.Subtract(0.5f)).Add(this.B.X.Multiply(0.5f)), this.A.Y.Multiply(1f.Subtract(0.5f)).Add(this.B.Y.Multiply(0.5f)), this.A.Z.Multiply(1f.Subtract(0.5f)).Add(this.B.Z.Multiply(0.5f)));
        ...
        [MethodImpl(AggressiveInlining)] public Point3D Size() => new Vector3(this.B.X, this.B.Y, this.B.Z).Subtract(new Vector3(this.A.X, this.A.Y, this.A.Z));
