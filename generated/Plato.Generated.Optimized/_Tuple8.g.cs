...
namespace Ara3D.Geometry
{
    ...
    public partial struct Tuple8<T0, T1, T2, T3, T4, T5, T6, T7>
    {
        ...
        [MethodImpl(AggressiveInlining)] public bool Equals(Tuple8<T0, T1, T2, T3, T4, T5, T6, T7> other) => X0.Equals(other.X0) && X1.Equals(other.X1) && X2.Equals(other.X2) && X3.Equals(other.X3) && X4.Equals(other.X4) && X5.Equals(other.X5) && X6.Equals(other.X6) && X7.Equals(other.X7);
        [MethodImpl(AggressiveInlining)] public bool NotEquals(Tuple8<T0, T1, T2, T3, T4, T5, T6, T7> other) => !(X0.Equals(other.X0) && X1.Equals(other.X1) && X2.Equals(other.X2) && X3.Equals(other.X3) && X4.Equals(other.X4) && X5.Equals(other.X5) && X6.Equals(other.X6) && X7.Equals(other.X7));
        [MethodImpl(AggressiveInlining)] public override bool Equals(object obj) => obj is Tuple8<T0, T1, T2, T3, T4, T5, T6, T7> other ? Equals(other) : false;
