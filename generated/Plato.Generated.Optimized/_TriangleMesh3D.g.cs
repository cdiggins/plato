...
namespace Ara3D.Geometry
{
    ...
    public partial struct TriangleMesh3D: IIndexedGeometry3D<TriangleMesh3D, Integer3>
    {
        ...
        [MethodImpl(AggressiveInlining)] IReadOnlyList<Integer3> IIndexedGeometry3D<Integer3>.FaceIndices() => FaceIndices;
        ...
        [MethodImpl(AggressiveInlining)] public TriangleMesh3D Deform(System.Func<Point3D, Point3D> f){
            ...
            {
                _lp13[_i13] = f(_s13[_i13]);
            }
            return (_lp13, this.FaceIndices);
        }

        [MethodImpl(AggressiveInlining)] public TriangleMesh3D Transform(Transform3D t){
            var _var5 = t;
            {
                var _s14 = this.Points;
                var _n14 = _s14.Count;
                var _lp14 = new Point3D[_n14];
                for (var _i14 = 0; _i14 < _n14; _i14++)
                {
                    var p_25 = _s14[_i14];
                    _lp14[_i14] = new Vector3(p_25.X, p_25.Y, p_25.Z).Transform(t.Matrix);
                }
                return new TriangleMesh3D(_lp14, this.FaceIndices);
            }
        }
