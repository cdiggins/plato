...
namespace Ara3D.Geometry
{
    ...
    public partial struct Translation3D: IRigidTransform3D
    {
        ...
        [MethodImpl(AggressiveInlining)] public Matrix4x4 Matrix() => Ara3D.Geometry.Matrix4x4.CreateTranslation(this.Vector);
        ...
        [MethodImpl(AggressiveInlining)] public Vector3 Multiply(Vector3 v) => v.TransformNormal(Ara3D.Geometry.Matrix4x4.CreateTranslation(this.Vector));
        ...
        [MethodImpl(AggressiveInlining)] public Transform3D Transform3D() => Ara3D.Geometry.Matrix4x4.CreateTranslation(this.Vector);
        [MethodImpl(AggressiveInlining)]  public static implicit operator Transform3D(Translation3D x) => x.Transform3D();
        [MethodImpl(AggressiveInlining)] public Matrix4x4 Matrix4x4() => Ara3D.Geometry.Matrix4x4.CreateTranslation(this.Vector);
