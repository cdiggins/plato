...
namespace Ara3D.Geometry
{
    ...
    public partial struct Bounds3D: BoundsLike<Bounds3D, Point3D, Vector3D>
    {
        ...
        Point3D BoundsLike<Bounds3D, Point3D, Vector3D>.Min { [MethodImpl(AggressiveInlining)] get => Min; }
        Point3D BoundsLike<Point3D, Vector3D>.Min { [MethodImpl(AggressiveInlining)] get => Min; }
        Point3D BoundsLike<Bounds3D, Point3D, Vector3D>.Max { [MethodImpl(AggressiveInlining)] get => Max; }
        Point3D BoundsLike<Point3D, Vector3D>.Max { [MethodImpl(AggressiveInlining)] get => Max; }

        // Implemented interface functions
        public static Bounds3D Empty { [MethodImpl(AggressiveInlining)] get  => (new Point3D(Ara3D.Geometry.Number.MaxValue, Ara3D.Geometry.Number.MaxValue, Ara3D.Geometry.Number.MaxValue), new Point3D(Ara3D.Geometry.Number.MinValue, Ara3D.Geometry.Number.MinValue, Ara3D.Geometry.Number.MinValue)); } 
        public Boolean IsEmpty { [MethodImpl(AggressiveInlining)] get  => this.Min.X.GreaterThan(this.Max.X).Or(this.Min.Y.GreaterThan(this.Max.Y)).Or(this.Min.Z.GreaterThan(this.Max.Z)); } 
        public Point3D Center { [MethodImpl(AggressiveInlining)] get  => this.Min.MidPoint(this.Max); } 
