...
namespace Ara3D.Geometry
{
    ...
    public readonly partial struct PolarCoordinate: IValue<PolarCoordinate>, System.IFormattable, System.ISpanFormattable, System.IParsable<PolarCoordinate>, System.ISpanParsable<PolarCoordinate>
    {
        ...
        // Regular Constructor
        [MethodImpl(AggressiveInlining)] [JsonConstructor] public PolarCoordinate(Number radius, Angle angle) { Radius = radius; Angle = angle; }
        ...
        public static bool TryParse(System.ReadOnlySpan<char> input, System.IFormatProvider provider, out PolarCoordinate result)
        {
            result = default;
            Number _v0 = default;
            Angle _v1 = default;
            ...
            result = new PolarCoordinate(_v0, _v1);
            return true;
        }
        [MethodImpl(AggressiveInlining)] public static bool TryParse(string input, System.IFormatProvider provider, out PolarCoordinate result) => TryParse((System.ReadOnlySpan<char>)input, provider, out result);
        [MethodImpl(AggressiveInlining)] public static bool TryParse(string input, out PolarCoordinate result) => TryParse((System.ReadOnlySpan<char>)input, null, out result);
        public static PolarCoordinate Parse(System.ReadOnlySpan<char> input, System.IFormatProvider provider) => TryParse(input, provider, out var result) ? result : throw PlatoJson.BadFormat("PolarCoordinate", input);
        [MethodImpl(AggressiveInlining)] public static PolarCoordinate Parse(string input, System.IFormatProvider provider) => Parse((System.ReadOnlySpan<char>)input, provider);
        [MethodImpl(AggressiveInlining)] public static PolarCoordinate Parse(string input) => Parse((System.ReadOnlySpan<char>)input, null);
        [MethodImpl(AggressiveInlining)] public static PolarCoordinate FromJson(string input) => Parse((System.ReadOnlySpan<char>)input, null);
