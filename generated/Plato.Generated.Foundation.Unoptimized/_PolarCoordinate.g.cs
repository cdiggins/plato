...
namespace Ara3D.Geometry
{
    ...
    public readonly partial struct PolarCoordinate: IValue<PolarCoordinate>, System.IFormattable, System.ISpanFormattable, System.IParsable<PolarCoordinate>, System.ISpanParsable<PolarCoordinate>
    {
        ...
        [MethodImpl(AggressiveInlining)] public static bool TryParse(System.ReadOnlySpan<char> input, System.IFormatProvider provider, out PolarCoordinate result) => PlatoJson.TryDeserialize(input, out result);
        [MethodImpl(AggressiveInlining)] public static bool TryParse(string input, System.IFormatProvider provider, out PolarCoordinate result) => PlatoJson.TryDeserialize((System.ReadOnlySpan<char>)input, out result);
        [MethodImpl(AggressiveInlining)] public static bool TryParse(string input, out PolarCoordinate result) => PlatoJson.TryDeserialize((System.ReadOnlySpan<char>)input, out result);
        [MethodImpl(AggressiveInlining)] public static PolarCoordinate Parse(System.ReadOnlySpan<char> input, System.IFormatProvider provider) => PlatoJson.Deserialize<PolarCoordinate>(input);
        [MethodImpl(AggressiveInlining)] public static PolarCoordinate Parse(string input, System.IFormatProvider provider) => PlatoJson.Deserialize<PolarCoordinate>((System.ReadOnlySpan<char>)input);
        [MethodImpl(AggressiveInlining)] public static PolarCoordinate Parse(string input) => PlatoJson.Deserialize<PolarCoordinate>((System.ReadOnlySpan<char>)input);
        [MethodImpl(AggressiveInlining)] public static PolarCoordinate FromJson(string input) => PlatoJson.Deserialize<PolarCoordinate>((System.ReadOnlySpan<char>)input);
