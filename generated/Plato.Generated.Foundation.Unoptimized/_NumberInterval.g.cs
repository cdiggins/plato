...
namespace Ara3D.Geometry
{
    ...
    public partial struct NumberInterval: IntervalLike<NumberInterval, Number>
    {
        // Fields
        ...
        Number IntervalLike<NumberInterval, Number>.Start { [MethodImpl(AggressiveInlining)] get => Start; }
        Number IntervalLike<Number>.Start { [MethodImpl(AggressiveInlining)] get => Start; }
        Number IntervalLike<NumberInterval, Number>.End { [MethodImpl(AggressiveInlining)] get => End; }
        Number IntervalLike<Number>.End { [MethodImpl(AggressiveInlining)] get => End; }

        // Implemented interface functions
        public static NumberInterval UnitInterval { [MethodImpl(AggressiveInlining)] get  => new NumberInterval(((Number)0), ((Number)1)); } 
        [MethodImpl(AggressiveInlining)] public Number At(Number t) => this.Lerp(t);
        public Number this[Number t] { [MethodImpl(AggressiveInlining)]  get => At(t); }
