...
namespace Ara3D.Geometry
{
    ...
    public readonly partial struct Tuple8<T0, T1, T2, T3, T4, T5, T6, T7>: System.IFormattable, System.ISpanFormattable, System.IParsable<Tuple8<T0, T1, T2, T3, T4, T5, T6, T7>>, System.ISpanParsable<Tuple8<T0, T1, T2, T3, T4, T5, T6, T7>>
    {
        ...
        public static bool TryParse(System.ReadOnlySpan<char> input, System.IFormatProvider provider, out Tuple8<T0, T1, T2, T3, T4, T5, T6, T7> result)
        {
            result = default;
            T0 _v0 = default;
            T1 _v1 = default;
            ...
            result = new Tuple8<T0, T1, T2, T3, T4, T5, T6, T7>(_v0, _v1, _v2, _v3, _v4, _v5, _v6, _v7);
            return true;
        }
        [MethodImpl(AggressiveInlining)] public static bool TryParse(string input, System.IFormatProvider provider, out Tuple8<T0, T1, T2, T3, T4, T5, T6, T7> result) => TryParse((System.ReadOnlySpan<char>)input, provider, out result);
        [MethodImpl(AggressiveInlining)] public static bool TryParse(string input, out Tuple8<T0, T1, T2, T3, T4, T5, T6, T7> result) => TryParse((System.ReadOnlySpan<char>)input, null, out result);
        public static Tuple8<T0, T1, T2, T3, T4, T5, T6, T7> Parse(System.ReadOnlySpan<char> input, System.IFormatProvider provider) => TryParse(input, provider, out var result) ? result : throw PlatoJson.BadFormat("Tuple8", input);
        [MethodImpl(AggressiveInlining)] public static Tuple8<T0, T1, T2, T3, T4, T5, T6, T7> Parse(string input, System.IFormatProvider provider) => Parse((System.ReadOnlySpan<char>)input, provider);
        [MethodImpl(AggressiveInlining)] public static Tuple8<T0, T1, T2, T3, T4, T5, T6, T7> Parse(string input) => Parse((System.ReadOnlySpan<char>)input, null);
        [MethodImpl(AggressiveInlining)] public static Tuple8<T0, T1, T2, T3, T4, T5, T6, T7> FromJson(string input) => Parse((System.ReadOnlySpan<char>)input, null);
