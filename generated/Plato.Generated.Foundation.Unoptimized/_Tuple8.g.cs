...
namespace Ara3D.Geometry
{
    ...
    public readonly partial struct Tuple8<T0, T1, T2, T3, T4, T5, T6, T7>: System.IFormattable, System.ISpanFormattable, System.IParsable<Tuple8<T0, T1, T2, T3, T4, T5, T6, T7>>, System.ISpanParsable<Tuple8<T0, T1, T2, T3, T4, T5, T6, T7>>
    {
        // Fields
        ...
        // Regular Constructor
        [MethodImpl(AggressiveInlining)] [JsonConstructor] public Tuple8(T0 x0, T1 x1, T2 x2, T3 x3, T4 x4, T5 x5, T6 x6, T7 x7) { X0 = x0; X1 = x1; X2 = x2; X3 = x3; X4 = x4; X5 = x5; X6 = x6; X7 = x7; }
        ...
        [MethodImpl(AggressiveInlining)] public static bool TryParse(System.ReadOnlySpan<char> input, System.IFormatProvider provider, out Tuple8<T0, T1, T2, T3, T4, T5, T6, T7> result) => PlatoJson.TryDeserialize(input, out result);
        [MethodImpl(AggressiveInlining)] public static bool TryParse(string input, System.IFormatProvider provider, out Tuple8<T0, T1, T2, T3, T4, T5, T6, T7> result) => PlatoJson.TryDeserialize((System.ReadOnlySpan<char>)input, out result);
        [MethodImpl(AggressiveInlining)] public static bool TryParse(string input, out Tuple8<T0, T1, T2, T3, T4, T5, T6, T7> result) => PlatoJson.TryDeserialize((System.ReadOnlySpan<char>)input, out result);
        [MethodImpl(AggressiveInlining)] public static Tuple8<T0, T1, T2, T3, T4, T5, T6, T7> Parse(System.ReadOnlySpan<char> input, System.IFormatProvider provider) => PlatoJson.Deserialize<Tuple8<T0, T1, T2, T3, T4, T5, T6, T7>>(input);
        [MethodImpl(AggressiveInlining)] public static Tuple8<T0, T1, T2, T3, T4, T5, T6, T7> Parse(string input, System.IFormatProvider provider) => PlatoJson.Deserialize<Tuple8<T0, T1, T2, T3, T4, T5, T6, T7>>((System.ReadOnlySpan<char>)input);
        [MethodImpl(AggressiveInlining)] public static Tuple8<T0, T1, T2, T3, T4, T5, T6, T7> Parse(string input) => PlatoJson.Deserialize<Tuple8<T0, T1, T2, T3, T4, T5, T6, T7>>((System.ReadOnlySpan<char>)input);
        [MethodImpl(AggressiveInlining)] public static Tuple8<T0, T1, T2, T3, T4, T5, T6, T7> FromJson(string input) => PlatoJson.Deserialize<Tuple8<T0, T1, T2, T3, T4, T5, T6, T7>>((System.ReadOnlySpan<char>)input);
