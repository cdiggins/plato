...
namespace Ara3D.Geometry
{
    ...
    public partial struct Bounds2D: BoundsLike<Bounds2D, Point2D, Vector2D>
    {
        ...
        [MethodImpl(AggressiveInlining)] Point2D BoundsLike<Bounds2D, Point2D, Vector2D>.Min() => Min;
        [MethodImpl(AggressiveInlining)] Point2D BoundsLike<Point2D, Vector2D>.Min() => Min;
        [MethodImpl(AggressiveInlining)] Point2D BoundsLike<Bounds2D, Point2D, Vector2D>.Max() => Max;
        [MethodImpl(AggressiveInlining)] Point2D BoundsLike<Point2D, Vector2D>.Max() => Max;
