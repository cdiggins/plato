...
namespace Ara3D.Geometry
{
    ...
    public partial struct Vector8
    {
        ...
        [MethodImpl(AggressiveInlining)] public Vector4 Lower() => Value.GetLower();

        [MethodImpl(AggressiveInlining)] public Vector4 Upper() => Value.GetUpper();
        ...
        [MethodImpl(AggressiveInlining)] public Vector8 Abs() => Vector256.Abs(Value);

        [MethodImpl(AggressiveInlining)]
        public Number Dot(Vector8 other) => Vector256.Dot(Value, other.Value);

        /// <summary>Reciprocal (1/x) of each element</summary>
        [MethodImpl(AggressiveInlining)] public Vector8 Reciprocal() => Avx.Reciprocal(Value);

        /// <summary>Approximate reciprocal of the square root of each element: 1 / sqrt(x)</summary>
        [MethodImpl(AggressiveInlining)] public Vector8 ReciprocalSqrtEstimate() => Avx.ReciprocalSqrt(Value);

        [MethodImpl(AggressiveInlining)] public Vector8 Sqrt() => Vector256.Sqrt(Value);

        /// <summary>Square each element</summary>
        [MethodImpl(AggressiveInlining)] public Vector8 Sqr() => this * this;

        [MethodImpl(AggressiveInlining)] public Number Sum() => Vector256.Sum(Value);

        [MethodImpl(AggressiveInlining)] public Number FirstElement() => Vector256.ToScalar(Value);
