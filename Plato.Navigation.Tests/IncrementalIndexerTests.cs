...
public class IncrementalIndexerTests
{
    ...
    {
        var indexer = new IncrementalIndexer();
        var first = new FilePath(Path.Combine(Corpus.RepoRoot.Value, "plato-src", "cache_a.plato"));
        var second = new FilePath(Path.Combine(Corpus.RepoRoot.Value, "plato-src", "cache_b.plato"));
    ...
    {
        var indexer = new IncrementalIndexer();
        var a = new FilePath(Path.Combine(Corpus.RepoRoot.Value, "plato-src", "cache_a.plato"));
        var b = new FilePath(Path.Combine(Corpus.RepoRoot.Value, "plato-src", "cache_b.plato"));
    ...
    {
        var indexer = new IncrementalIndexer();
        var file = new FilePath(Path.Combine(Corpus.RepoRoot.Value, "plato-src", "cache_a.plato"));
    ...
    private static FilePath NewFile { get; } =
        new(Path.Combine(Corpus.RepoRoot.Value, "plato-src", "cache_probe.plato"));
