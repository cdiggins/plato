...
namespace Ara3D.Geometry
{
    ...
    public static class NumberExtensions
    {
        ...
        [MethodImpl(AggressiveInlining)] public static Number InverseLerp(this float a, Number b, Number v) => ((Number)a).InverseLerp(b, v);
        [MethodImpl(AggressiveInlining)] public static Number Remap(this float v, Number inA, Number inB, Number outA, Number outB) => ((Number)v).Remap(inA, inB, outA, outB);
        ...
        [MethodImpl(AggressiveInlining)] public static Number OpUnion(this float a, Number b) => ((Number)a).OpUnion(b);
        [MethodImpl(AggressiveInlining)] public static Number OpIntersect(this float a, Number b) => ((Number)a).OpIntersect(b);
        [MethodImpl(AggressiveInlining)] public static Number OpSubtract(this float a, Number b) => ((Number)a).OpSubtract(b);
        [MethodImpl(AggressiveInlining)] public static Number OpSmoothUnion(this float a, Number b, Number k) => ((Number)a).OpSmoothUnion(b, k);
