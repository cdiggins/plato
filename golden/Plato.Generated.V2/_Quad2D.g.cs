...
namespace Ara3D.Geometry
{
    ...
    public partial struct Quad2D: IPolygon2D<Quad2D>, IArrayLike<Quad2D, Point2D>
    {
        ...
        public Point2D Center { [MethodImpl(AggressiveInlining)] get  => this.A.Add(this.B).Add(this.C).Add(this.D).Divide(((Number)(4f))); } 
        ...
        public static Quad2D Unit { [MethodImpl(AggressiveInlining)] get  => ((0f, 0f), (1f, 0f), (1f, 1f), (0f, 1f)); } 
