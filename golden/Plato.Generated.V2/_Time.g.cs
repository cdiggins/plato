...
namespace Ara3D.Geometry
{
    ...
    {
        [MethodImpl(AggressiveInlining)] public static Boolean LessThanOrEquals(this Time x, Time y) => x.LessThanOrEquals(y);
        [MethodImpl(AggressiveInlining)] public static Time Modulo(this Time self, Number other) => self.Modulo(other);
        [MethodImpl(AggressiveInlining)] public static Time Divide(this Time self, Number other) => self.Divide(other);
        [MethodImpl(AggressiveInlining)] public static Time Multiply(this Time self, Number other) => self.Multiply(other);
    }
}
