...
// Created on 2026-07-19 10:06:55 PM
...
float Pi();
float TwoPi();
vec2 At(Bezier4 b, int i);
int Count(Bezier4 b);
vec2 Eval(Bezier4 b, float t);
float DistanceAt(Bezier4 b, vec2 p, float t);
...
vec2 At(Bezier4 b, int i) { return ((i <= 0) ? b.P0 : ((i == 1) ? b.P1 : ((i == 2) ? b.P2 : b.P3))); }

int Count(Bezier4 b) { return 4; }

vec2 Eval(Bezier4 b, float t)
{
    vec2 a0 = Lerp(At(b, 0), At(b, 1), t);
    vec2 a1 = Lerp(At(b, 1), At(b, 2), t);
    vec2 a2 = Lerp(At(b, 2), At(b, 3), t);
    vec2 c0 = Lerp(a0, a1, t);
    vec2 c1 = Lerp(a1, a2, t);
    return Lerp(c0, c1, t);
}

float DistanceAt(Bezier4 b, vec2 p, float t) { return Distance(Eval(b, t), p); }
