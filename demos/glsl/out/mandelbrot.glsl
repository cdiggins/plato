...
// Created on 2026-07-19 10:06:54 PM
...
Complex Multiply(Complex a, Complex b) { return Complex(((a.Re * b.Re) - (a.Im * b.Im)), ((a.Re * b.Im) + (a.Im * b.Re))); }

float NormSquared(Complex z) { return ((z.Re * z.Re) + (z.Im * z.Im)); }

Complex Iterate(Complex z, Complex c) { return Add(Multiply(z, z), c); }
