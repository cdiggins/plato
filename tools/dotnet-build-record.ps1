...
.EXAMPLE
    ...
    .\tools\dotnet-build-record.ps1 -Project .\generated\Plato.Generated.Foundation.Unoptimized\Plato.Generated.Foundation.Unoptimized.csproj -TargetName generated-foundation-unoptimized
#>
[CmdletBinding()]
param(
