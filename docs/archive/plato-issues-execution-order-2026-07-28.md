...
- Lessons library triage (gates + packets): [reports/plato-257-lessons-v1-recommendations-numbered.md](../submodules/Plato/docs/plato-257-lessons-v1-recommendations-numbered.md) (reviewer §A / item 475)
- Older consumer-driven ladder: [archive/plato-refactoring-recommendations-2026-07-12.md](plato-refactoring-recommendations-2026-07-12.md)
