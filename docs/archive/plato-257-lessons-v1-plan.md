...
3. **Respect v3 semantics.** The doc comments and conventions in
   ...
   [`docs/SEMANTICS.md`] (plato-261 reference) governs any language
   claims.
...
(`docs/reports/plato-257-lessons-v1-recommendations.md`), de-duplicates, and files tracker
...
- **After each wave** the orchestrator: (1) skims each lesson for rule violations
  ...
  (2) harvests recommendations into `docs/reports/plato-257-lessons-v1-recommendations.md`,
