...
public readonly partial struct Number
{
    ...
    public Number SmoothStep =>
        this.Square.Multiply(3.Subtract(this.Twice));
    public Number Pow2 =>
        this.Multiply(this);
...
{
    public TR Aggregate<TR>(Function2<Number, TR, TR> f) =>
        {
            r;
            {
                i;
                throw new NotImplementedException("Loops not implemented yet!");;
            }
            ;
            r;
        }
...
public readonly partial struct AlignedBox2D
{
    ...
    public Point2D Clamp(Point2D value) =>
        value.Lerp(this.Min, this.Max, value.Unlerp(this.Min, this.Max).Clamp(0, 1));
