namespace Ara3D.DoublePrecision
{
    ...
    public readonly partial struct Rect: Polygon2D
    {
        ...
        public Ara3D.SinglePrecision.Rect ChangePrecision() => (Center.ChangePrecision(), Size.ChangePrecision());
        public static implicit operator Ara3D.SinglePrecision.Rect(Rect self) => self.ChangePrecision();
