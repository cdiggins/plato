...
| P4 | `intervals`, `intervals-transforms-deformable` | `intervals-bounds.concepts`, `transforms.concepts` | IntervalLike, BoundsLike, Transformable, Deformable2D, Deformable3D |
