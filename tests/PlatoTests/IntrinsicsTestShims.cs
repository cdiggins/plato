...
{
    /// <summary>
    /// The Plato.Intrinsics shared sources call a handful of extension methods that normally
    /// come from the GENERATED library (which PlatoTests deliberately does not compile).
    /// IntrinsicsSurfaceTests only reflects over the V2 surface, never executes these, so
    ...
    /// </summary>
    internal static class IntrinsicsTestShims
    {
