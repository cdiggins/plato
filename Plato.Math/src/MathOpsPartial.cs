...
namespace Plato.Math
{
    ...
    public static partial class MathOps
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Box[] ToBoxArray(this float[] m)
        {
            const int numFloats = 6;
            Debug.Assert((m.Length % numFloats) == 0);
            var ret = new Box[m.Length / numFloats];
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Box ToBox(this Stats<Vector3> stats)
            => new Box(stats.Min, stats.Max);

        /// <summary>
        /// Returns the bounding box, given stats on a DVector3
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DBox ToBox(this Stats<DVector3> stats)
            => new DBox(stats.Min, stats.Max);

        /// <summary>
        /// Returns the bounding box for a series of points
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Box ToBox(this IEnumerable<Vector3> points)
            => Box.Create(points);
