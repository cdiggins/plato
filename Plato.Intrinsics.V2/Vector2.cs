...
namespace Ara3D.Geometry
{
    ...
    public readonly partial struct Vector2 
    {
        ...
        /// </summary>
        [MethodImpl(AggressiveInlining)] public Vector2 Normalize() => SNVector2.Normalize(Value);
        ...
        /// </summary>
        [MethodImpl(AggressiveInlining)] public Vector2 Abs() => SNVector2.Abs(Value);

        /// <summary>
        /// Returns the square root of each element in the specified <see cref="Vector2"/>.
        /// </summary>
        [MethodImpl(AggressiveInlining)] public Vector2 Sqrt() => SNVector2.SquareRoot(Value);
