...
namespace Ara3D.Geometry
{
    ...
    public partial struct Vector4 
    {
        ...
        /// </summary>
        [MethodImpl(AggressiveInlining)] public Vector4 Normalize() => SNVector4.Normalize(Value);
        ...
        /// </summary>
        [MethodImpl(AggressiveInlining)] public Vector4 Abs() => SNVector4.Abs(Value);

        /// <summary>
        /// Returns the square root of each element in the specified <see cref="Vector4"/>.
        /// </summary>
        [MethodImpl(AggressiveInlining)] public Vector4 Sqrt() => SNVector4.SquareRoot(Value);
        ...
        [MethodImpl(AggressiveInlining)] public Vector4 XYWZ() => new(X, Y, W, Z);
        [MethodImpl(AggressiveInlining)] public Vector4 XYZW() => new(X, Y, Z, W);
        [MethodImpl(AggressiveInlining)] public Vector4 XWYZ() => new(X, W, Y, Z);
        [MethodImpl(AggressiveInlining)] public Vector4 XWZY() => new(X, W, Z, Y);
        [MethodImpl(AggressiveInlining)] public Vector4 XZYW() => new(X, Z, Y, W);
        [MethodImpl(AggressiveInlining)] public Vector4 XZWY() => new(X, Z, W, Y);
        [MethodImpl(AggressiveInlining)] public Vector4 YXZW() => new(Y, X, Z, W);
        [MethodImpl(AggressiveInlining)] public Vector4 YXWZ() => new(Y, X, W, Z);
        [MethodImpl(AggressiveInlining)] public Vector4 YZXW() => new(Y, Z, X, W);
        [MethodImpl(AggressiveInlining)] public Vector4 YZWX() => new(Y, Z, W, X);
        [MethodImpl(AggressiveInlining)] public Vector4 YWXZ() => new(Y, W, X, Z);
        [MethodImpl(AggressiveInlining)] public Vector4 YWZX() => new(Y, W, Z, X);
        [MethodImpl(AggressiveInlining)] public Vector4 ZXYW() => new(Z, X, Y, W);
        [MethodImpl(AggressiveInlining)] public Vector4 ZXWY() => new(Z, X, W, Y);
        [MethodImpl(AggressiveInlining)] public Vector4 ZYXW() => new(Z, Y, X, W);
        [MethodImpl(AggressiveInlining)] public Vector4 ZYWX() => new(Z, Y, W, X);
        [MethodImpl(AggressiveInlining)] public Vector4 ZWXY() => new(Z, W, X, Y);
        [MethodImpl(AggressiveInlining)] public Vector4 ZWYX() => new(Z, W, Y, X);
        [MethodImpl(AggressiveInlining)] public Vector4 WXZY() => new(W, X, Z, Y);
        [MethodImpl(AggressiveInlining)] public Vector4 WYZX() => new(W, Y, Z, X);
