...
namespace Ara3D.Geometry
{
    ...
    public partial struct Angle 
    {
        ...
        // NOTE (V3): the implicit float/Number/Integer conversions are emitted by the
        // generated partial (_Angle.g.cs); declaring them here too is CS0557.

        public float Radians { [MethodImpl(AggressiveInlining)] get => Value; }

        public float Amount { [MethodImpl(AggressiveInlining)] get => Value; }
        // -------------------------------------------------------------------------------
