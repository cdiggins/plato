...
namespace Plato.Math
{
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Box2D BoundingBox() => Box2D.Create(A.Min(B), A.Max(B));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Intersects(Box2D thisBox, Line2D otherLine, Box2D otherBox)
    ...
    public partial struct DBox
    {
        public Box Box
            => new Box(Min.Vector3, Max.Vector3);
    }
