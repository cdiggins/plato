...
namespace Plato.Math
{
    public partial struct Box2D
    {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Box2D Translate(Vector2 offset)
            => new Box2D(Min + offset, Max + offset);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ContainmentType Contains(Box2D box)
        {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Box2D Create(IEnumerable<Vector2> points)
        {
            ...
            return new Box2D(minVec, maxVec);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Box2D Create(params Vector2[] points)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool Intersects(Box2D box1, Box2D box2)
        ...
        public static readonly Box2D Unit
            = new Box2D(Vector2.Zero, new Vector2(1));
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Box2D Scale(float scale)
            => new Box2D(Recenter().Min * scale, Recenter().Max * scale).Translate(Center);
    }
}
