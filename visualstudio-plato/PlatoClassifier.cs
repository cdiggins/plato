...
namespace PlatoVSIX
{
    ...
    public class PlatoClassifier : IClassifier
    {
        ...
        // Keep in sync with vscode-plato/syntaxes/plato.tmLanguage.json
        private static readonly string[] KeywordDefinitions = new[]
        {
            "unique", "type", "interface", "concept", "library", "primitive"
        };

        private static readonly string[] KeywordClauses = new[]
        {
            "implements", "inherits", "where"
        };

        private static readonly string[] KeywordStatements = new[]
        {
            "if", "else", "for", "foreach", "while", "do", "switch", "case", "default", "break", "continue",
            "return", "throw", "try", "catch", "finally", "yield", "using",
            "and", "or", "is", "as", "in", "typeof", "nameof", "new",
            "ref", "out", "params", "true", "false", "null", "Self"
        };
