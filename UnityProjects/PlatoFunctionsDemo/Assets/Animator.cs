...
public static class AnimationExtensions
{
    ...
    public static AnimatedValue<Vector3> Animate(this Vector3 from, Vector3 to, EaseType type = EaseType.Linear, double duration = 1)
        => Animate(from, to, (a, b, t) => Vector3.Lerp(a, b, (float)t), type, duration);
}
...
public class Animator : MonoBehaviour
{
    ...
    public IAnimationCurve AnimationCurve => EaseType.ToAnimationCurve().SetDurationAndRescale(Duration);
    ...
    public void Start()
    {
        GetVector3().Animate(Target, (a, b, t) => Vector3.Lerp(a, b, (float)t), EaseType, Duration);
        State = State.Start(UnityEngine.Time.timeAsDouble);
    }

    public void Update()
    {
        State = State.Update(UnityEngine.Time.timeAsDouble);
        Set(AnimatedValue.Evaluate(State));
    }
}
...
/*
 ...
 {
     public List<string> statList = new{ "hp", "mp", "str", "lck", "dmg" }; 
