...
namespace Ara3D.Geometry
{
    ...
    public partial struct CubicBezier3D: IOpenShape
    {
        ...
        [MethodImpl(AggressiveInlining)] public bool Equals(CubicBezier3D other) => A.Equals(other.A) && B.Equals(other.B) && C.Equals(other.C) && D.Equals(other.D);
        [MethodImpl(AggressiveInlining)] public bool NotEquals(CubicBezier3D other) => !(A.Equals(other.A) && B.Equals(other.B) && C.Equals(other.C) && D.Equals(other.D));
