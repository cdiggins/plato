...
namespace Ara3D.Geometry
{
    ...
    public interface IArrayLike<Self, T>: IArrayLike<T> where Self : IArrayLike<Self, T>
    {
        IReadOnlyList<T> Components();
    }
    public interface IVectorLike: IArrayLike<float>
    {
    }
    public interface IVectorLike<Self>: IVectorLike, IInterpolatable<Self>, IScalarArithmetic<Self>, IArrayLike<Self, float> where Self : IVectorLike<Self>
    {
    }
    ...
    public interface INumerical: IVectorLike
    {
    }
    public interface INumerical<Self>: INumerical, IVectorLike<Self>, IArithmetic<Self> where Self : INumerical<Self>
    {
    }
    public interface IVector: INumerical
    {
    }
    public interface IVector<Self>: IVector, INumerical<Self> where Self : IVector<Self>
    {
    }
    ...
    public interface IMeasure: IVectorLike
    {
    }
    public interface IMeasure<Self>: IMeasure, IVectorLike<Self>, IOrderable<Self> where Self : IMeasure<Self>
    {
    }
    ...
    public interface IPolyLine2D<Self>: IPolyLine2D, IPointGeometry2D<Self>, IOpenClosedShape, ICurve2D where Self : IPolyLine2D<Self>
    {
    }
    public interface IPolyLine3D: IPointGeometry3D, IOpenClosedShape, ICurve3D
    {
    }
    public interface IPolyLine3D<Self>: IPolyLine3D, IPointGeometry3D<Self>, IOpenClosedShape, ICurve3D where Self : IPolyLine3D<Self>
    {
    }
    public interface IPolygon2D: IPolyLine2D, IClosedShape2D
    {
    }
    public interface IPolygon2D<Self>: IPolygon2D, IPolyLine2D<Self>, IClosedShape2D where Self : IPolygon2D<Self>
    {
    }
    public interface IPolygon3D: IPolyLine3D, IClosedShape3D
    {
    }
    public interface IPolygon3D<Self>: IPolygon3D, IPolyLine3D<Self>, IClosedShape3D where Self : IPolygon3D<Self>
    {
    }
    ...
    public interface IPointGeometry2D<Self>: IPointGeometry2D, IGeometry2D, IDeformable2D<Self> where Self : IPointGeometry2D<Self>
    {
        IReadOnlyList<Point2D> Points();
    }
    ...
    public interface IPointGeometry3D<Self>: IPointGeometry3D, IGeometry3D, IDeformable3D<Self> where Self : IPointGeometry3D<Self>
    {
        IReadOnlyList<Point3D> Points();
    }
    public interface IGeometricPrimitive2D: IPointGeometry2D
    {
    }
    public interface IGeometricPrimitive2D<Self>: IGeometricPrimitive2D, IPointGeometry2D<Self> where Self : IGeometricPrimitive2D<Self>
    {
    }
    public interface IGeometricPrimitive3D: IPointGeometry3D
    {
    }
    public interface IGeometricPrimitive3D<Self>: IGeometricPrimitive3D, IPointGeometry3D<Self> where Self : IGeometricPrimitive3D<Self>
    {
    }
    ...
    public interface IIndexedGeometry3D<IndexT>: IPointGeometry3D
    {
        IReadOnlyList<IndexT> FaceIndices();
    }
    public interface IIndexedGeometry3D<Self, IndexT>: IIndexedGeometry3D<IndexT>, IPointGeometry3D<Self> where Self : IIndexedGeometry3D<Self, IndexT>
    {
        IReadOnlyList<IndexT> FaceIndices();
    }
