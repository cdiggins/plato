...
namespace Ara3D.Geometry
{
    ...
    public partial struct Bounds3D: IBounds<Point3D, Vector3>, IDeformable3D<Bounds3D>, IArrayLike<Bounds3D, Point3D>
    {
        ...
        [MethodImpl(AggressiveInlining)] public Point3D Center() => this.Min.Average(this.Max);
        [MethodImpl(AggressiveInlining)] public static Bounds3D Empty() => (Constants.MaxPoint3D(), Constants.MinPoint3D());
        [MethodImpl(AggressiveInlining)] public Bounds3D Deform(System.Func<Point3D, Point3D> f) => this.Corners().Map(f).Bounds();
        [MethodImpl(AggressiveInlining)] public Vector3 Size() => this.Max.Subtract(this.Min);
