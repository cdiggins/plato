...
namespace Ara3D.Geometry
{
    ...
    public partial struct Vector8: IVector<Vector8>
    {
        ...
        public Vector8 ReciprocalSquareRootEstimate { [MethodImpl(AggressiveInlining)] get  => this.MapComponents((x)  => ((float)x).ReciprocalSquareRootEstimate()); } 
        ...
        [MethodImpl(AggressiveInlining)] public Vector8 Lerp(Vector8 b, Number t){
            var _var16 = ((float)t);
            return this.ZipComponents(b, (a1, b1)  => ((float)a1).Lerp(((float)(((float)b1))), ((float)(_var16))));
        }

        public Vector8 Pow2 { [MethodImpl(AggressiveInlining)] get  => this.MapComponents((x1)  => ((float)x1).Pow2()); } 
        public Vector8 Pow3 { [MethodImpl(AggressiveInlining)] get  => this.MapComponents((x1)  => ((float)x1).Pow3()); } 
