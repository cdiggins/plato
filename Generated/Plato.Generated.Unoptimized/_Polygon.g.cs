...
namespace Ara3D.Geometry
{
    ...
    public partial struct Polygon: IPolygon2D<Polygon>
    {
        ...
        [MethodImpl(AggressiveInlining)] public bool Equals(Polygon other) => Points.Equals(other.Points);
        [MethodImpl(AggressiveInlining)] public bool NotEquals(Polygon other) => !(Points.Equals(other.Points));
        [MethodImpl(AggressiveInlining)] public override bool Equals(object obj) => obj is Polygon other ? Equals(other) : false;
        ...
        [MethodImpl(AggressiveInlining)] IReadOnlyList<Point2D> IPointGeometry2D<Polygon>.Points() => Points;
