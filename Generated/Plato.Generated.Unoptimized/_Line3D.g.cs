...
namespace Ara3D.Geometry
{
    ...
    public partial struct Line3D: IDeformable3D<Line3D>, IInterval<Point3D>, IArrayLike<Line3D, Point3D>
    {
        ...
        [MethodImpl(AggressiveInlining)] public Vector3 Direction() => this.B.Subtract(this.A);
        [MethodImpl(AggressiveInlining)] public Ray3D Ray3D() => (this.A, this.Direction().Normalize());
        [MethodImpl(AggressiveInlining)]  public static implicit operator Ray3D(Line3D x) => x.Ray3D();
        [MethodImpl(AggressiveInlining)] public Bounds3D Bounds3D() => (this.A.Min(this.B), this.A.Max(this.B));
        ...
        [MethodImpl(AggressiveInlining)] public Point3D Center() => this.A.Average(this.B);
        ...
        [MethodImpl(AggressiveInlining)] public Point3D Size() => this.End().Subtract(this.Start());
