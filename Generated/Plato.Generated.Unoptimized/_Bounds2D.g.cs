...
namespace Ara3D.Geometry
{
    ...
    public partial struct Bounds2D: IBounds<Point2D, Vector2>, IArrayLike<Bounds2D, Point2D>
    {
        ...
        [MethodImpl(AggressiveInlining)] public Point2D Center() => this.Min.Average(this.Max);
        [MethodImpl(AggressiveInlining)] public static Bounds2D Empty() => (Constants.MaxPoint2D(), Constants.MinPoint2D());
        [MethodImpl(AggressiveInlining)] public Bounds3D Bounds3D() => this.To3D();
        [MethodImpl(AggressiveInlining)]  public static implicit operator Bounds3D(Bounds2D x) => x.Bounds3D();
        [MethodImpl(AggressiveInlining)] public Vector2 Size() => this.Max.Subtract(this.Min);
