...
namespace Ara3D.Geometry
{
    ...
    public partial struct Arc: IOpenShape2D
    {
        ...
        [MethodImpl(AggressiveInlining)] public bool Equals(Arc other) => Angles.Equals(other.Angles) && Circle.Equals(other.Circle);
        [MethodImpl(AggressiveInlining)] public bool NotEquals(Arc other) => !(Angles.Equals(other.Angles) && Circle.Equals(other.Circle));
