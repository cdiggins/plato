...
namespace Ara3D.Geometry
{
    ...
    public partial struct Box: ISolid
    {
        ...
        [MethodImpl(AggressiveInlining)] public Point3D Eval(Vector2 uv){
            ...
            return (((float)p.X).Multiply(((float)this.Extent.X)).Multiply(((float)(0.5f))), ((float)p.Y).Multiply(((float)this.Extent.Y)).Multiply(((float)(0.5f))), ((float)uv.Y).Subtract(((float)(0.5f))).Multiply(((float)this.Extent.Z)));
        }
