...
namespace Ara3D.Geometry
{
    ...
    public partial struct AnglePair: IInterval<Angle>
    {
        ...
        [MethodImpl(AggressiveInlining)] public Angle Size() => this.End.Subtract(this.Start);
        [MethodImpl(AggressiveInlining)] public Angle Center() => new Angle(this.Start.Value.Multiply(1f.Subtract(0.5f)).Add(this.End.Value.Multiply(0.5f)));
