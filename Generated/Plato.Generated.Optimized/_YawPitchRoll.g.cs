...
namespace Ara3D.Geometry
{
    ...
    public partial struct YawPitchRoll: IRotation3D
    {
        ...
        [MethodImpl(AggressiveInlining)] public Quaternion Quaternion() => Ara3D.Geometry.Quaternion.CreateFromYawPitchRoll(this.Yaw, this.Pitch, this.Roll);
        ...
        [MethodImpl(AggressiveInlining)] public Matrix4x4 Matrix() => Ara3D.Geometry.Quaternion.CreateFromYawPitchRoll(this.Yaw, this.Pitch, this.Roll).Matrix();
