...
namespace Ara3D.Geometry
{
    ...
    public partial struct YawPitchRoll: IRotation3D
    {
        ...
        [MethodImpl(AggressiveInlining)] public bool Equals(YawPitchRoll other) => Yaw.Equals(other.Yaw) && Pitch.Equals(other.Pitch) && Roll.Equals(other.Roll);
        [MethodImpl(AggressiveInlining)] public bool NotEquals(YawPitchRoll other) => !(Yaw.Equals(other.Yaw) && Pitch.Equals(other.Pitch) && Roll.Equals(other.Roll));
        [MethodImpl(AggressiveInlining)] public override bool Equals(object obj) => obj is YawPitchRoll other ? Equals(other) : false;
        ...
        [MethodImpl(AggressiveInlining)] public static YawPitchRoll Identity() => (((float)0f), ((float)0f), ((float)0f));
        public Matrix4x4 Matrix { [MethodImpl(AggressiveInlining)] get  => Ara3D.Geometry.Quaternion.CreateFromYawPitchRoll(this.Yaw, this.Pitch, this.Roll).Matrix; } 
        ...
        [MethodImpl(AggressiveInlining)] public Vector3 Multiply(Vector3 v) => v.TransformNormal(Ara3D.Geometry.Quaternion.CreateFromYawPitchRoll(this.Yaw, this.Pitch, this.Roll).Matrix);
        ...
        [MethodImpl(AggressiveInlining)] public Transform3D Transform3D() => Ara3D.Geometry.Quaternion.CreateFromYawPitchRoll(this.Yaw, this.Pitch, this.Roll).Matrix;
        [MethodImpl(AggressiveInlining)]  public static implicit operator Transform3D(YawPitchRoll x) => x.Transform3D();
        [MethodImpl(AggressiveInlining)] public Matrix4x4 Matrix4x4() => Ara3D.Geometry.Quaternion.CreateFromYawPitchRoll(this.Yaw, this.Pitch, this.Roll).Matrix;
