...
namespace Ara3D.Geometry
{
    ...
    public partial struct Chord: IClosedShape2D
    {
        ...
        [MethodImpl(AggressiveInlining)] public bool Equals(Chord other) => Arc.Equals(other.Arc);
        [MethodImpl(AggressiveInlining)] public bool NotEquals(Chord other) => !(Arc.Equals(other.Arc));
