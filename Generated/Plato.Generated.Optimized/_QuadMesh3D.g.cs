    ...
    public partial struct QuadMesh3D: IIndexedGeometry3D<QuadMesh3D, Integer4>
    {
        ...
        [MethodImpl(AggressiveInlining)] public QuadMesh3D Transform(Transform3D t){
            var _var13 = t;
            {
                ...
                {
                    var p_24 = _s26[_i26];
                    _lp26[_i26] = new Vector3(((float)p_24.X), ((float)p_24.Y), ((float)p_24.Z)).Transform(t.Matrix);
                }
                return new QuadMesh3D(_lp26, this.FaceIndices);
            }
        }
