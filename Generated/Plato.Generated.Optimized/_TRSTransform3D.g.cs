...
namespace Ara3D.Geometry
{
    ...
    public partial struct TRSTransform3D: ITransform3D
    {
        ...
        public Matrix4x4 Matrix { [MethodImpl(AggressiveInlining)] get  => this.Translation.Compose(this.Rotation).Compose(Ara3D.Geometry.Matrix4x4.CreateScale(((float)(((float)this.Scale.Amount.X))), ((float)(((float)this.Scale.Amount.Y))), ((float)(((float)this.Scale.Amount.Z))))); } 
