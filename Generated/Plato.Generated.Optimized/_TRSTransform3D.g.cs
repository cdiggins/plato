...
namespace Ara3D.Geometry
{
    ...
    public partial struct TRSTransform3D: ITransform3D
    {
        ...
        [MethodImpl(AggressiveInlining)] public Matrix4x4 Matrix() => this.Translation.Compose(this.Rotation).Compose(Ara3D.Geometry.Matrix4x4.CreateScale(((float)this.Scale.Amount.X), ((float)this.Scale.Amount.Y), ((float)this.Scale.Amount.Z)));
