...
namespace Ara3D.Geometry
{
    ...
    public partial struct Line3D: IDeformable3D<Line3D>, IInterval<Point3D>, IArrayLike<Line3D, Point3D>
    {
        ...
        public float Length { [MethodImpl(AggressiveInlining)] get  => ((float)this.B.Vector3().Subtract(this.A.Vector3()).Length); } 
        ...
        [MethodImpl(AggressiveInlining)] public Bounds3D Bounds3D() => (this.A.ZipComponents(this.B, (a, b)  => a.Min(b)), this.A.ZipComponents(this.B, (a, b)  => a.Max(b)));
        ...
        [MethodImpl(AggressiveInlining)] public Line3D Transform(Transform3D t){
            var _var2 = t;
            return this.Deform((p)  => p.Vector3().Transform(_var2.Matrix));
        }
