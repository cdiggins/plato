...
namespace Ara3D.Geometry
{
    ...
    public partial struct Pose3D: IRigidTransform3D
    {
        ...
        [MethodImpl(AggressiveInlining)] public Vector3 Multiply(Vector3 v) => v.TransformNormal(Ara3D.Geometry.Matrix4x4.CreateTranslation(this.Translation.Vector).Multiply(this.Rotation.Quaternion.Matrix));
        ...
        [MethodImpl(AggressiveInlining)] public Transform3D Transform3D() => Ara3D.Geometry.Matrix4x4.CreateTranslation(this.Translation.Vector).Multiply(this.Rotation.Quaternion.Matrix);
        [MethodImpl(AggressiveInlining)]  public static implicit operator Transform3D(Pose3D x) => x.Transform3D();
        [MethodImpl(AggressiveInlining)] public Matrix4x4 Matrix4x4() => Ara3D.Geometry.Matrix4x4.CreateTranslation(this.Translation.Vector).Multiply(this.Rotation.Quaternion.Matrix);
