...
namespace Ara3D.Geometry
{
    ...
    public partial struct Ray2D: IValue
    {
        ...
        [MethodImpl(AggressiveInlining)] public Ray3D Ray3D() => new Ray3D(new Point3D(((float)this.Origin.X), ((float)this.Origin.Y), 0), new Vector3(((float)this.Direction.X), ((float)this.Direction.Y), 0));
