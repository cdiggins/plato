...
namespace Ara3D.Geometry
{
    ...
    public partial struct Quad3D: IDeformable3D<Quad3D>, IArrayLike<Quad3D, Point3D>
    {
        ...
        public Vector3 Normal { [MethodImpl(AggressiveInlining)] get  => new Triangle3D(this.A, this.B, this.C).Normal.Average(new Triangle3D(this.C, this.D, this.A).Normal).Normalize(); } 
