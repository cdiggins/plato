    ...
    public partial struct Quad3D: IDeformable3D<Quad3D>, IArrayLike<Quad3D, Point3D>
    {
        ...
        public Vector3 Normal { [MethodImpl(AggressiveInlining)] get {
            ...
            for (var _i21 = 0; _i21 < _n21; _i21++)
            {
                ...
                _lp21[_i21] = ((float)a1_22).Multiply(1f.Subtract(((float)0.5f))).Add(((float)b1_23).Multiply(((float)0.5f)));
            }
        ...
        [MethodImpl(AggressiveInlining)] public Quad3D Transform(Transform3D t){
            var _var10 = t;
            return this.Deform((p)  => new Vector3(p.X, p.Y, p.Z).Transform(_var10.Matrix));
        }
