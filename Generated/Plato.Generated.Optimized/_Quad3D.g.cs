...
namespace Ara3D.Geometry
{
    ...
    public partial struct Quad3D: IDeformable3D<Quad3D>, IArrayLike<Quad3D, Point3D>
    {
        ...
        public Vector3 Normal { [MethodImpl(AggressiveInlining)] get  => this.TriangleA().CrossProductA().Normalize().Average(this.TriangleB().CrossProductA().Normalize()).Normalize(); } 
