...
namespace Ara3D.Geometry
{
    ...
    public partial struct Quad3D: IDeformable3D<Quad3D>, IArrayLike<Quad3D, Point3D>
    {
        ...
        public Vector3 Normal { [MethodImpl(AggressiveInlining)] get {
            var _s20a = new Triangle3D(this.A, this.B, this.C).Normal.Components();
            var _s20b = new Triangle3D(this.C, this.D, this.A).Normal.Components();
            ...
            for (var _i20 = 0; _i20 < _n20; _i20++)
            {
                ...
                _lp20[_i20] = a1_20.Multiply(((float)(1f.Subtract(((float)(0.5f)))))).Add(((float)(b1_21.Multiply(((float)(0.5f))))));
            }
            return Vector3.CreateFromComponents(_lp20).Normalize();
        }
         } 
