...
namespace Ara3D.Geometry
{
    ...
    public partial struct LineMesh3D: IIndexedGeometry3D<LineMesh3D, Integer2>
    {
        ...
        [MethodImpl(AggressiveInlining)] public LineMesh3D Deform(System.Func<Point3D, Point3D> f){
            ...
            return (_lp16, this.FaceIndices);
        }

        [MethodImpl(AggressiveInlining)] public LineMesh3D Transform(Transform3D t){
            var _var11 = t;
            {
                var _s17 = this.Points;
                var _n17 = _s17.Count;
                var _lp17 = new Point3D[_n17];
                for (var _i17 = 0; _i17 < _n17; _i17++)
                {
                    var p_12 = _s17[_i17];
                    _lp17[_i17] = new Vector3(((float)p_12.X), ((float)p_12.Y), ((float)p_12.Z)).Transform(t.Matrix);
                }
                return new LineMesh3D(_lp17, this.FaceIndices);
            }
        }
