...
namespace Ara3D.Geometry
{
    ...
    public partial struct Rotation3D: IRotation3D
    {
        ...
        [MethodImpl(AggressiveInlining)] public bool Equals(Rotation3D other) => Quaternion.Equals(other.Quaternion);
        [MethodImpl(AggressiveInlining)] public bool NotEquals(Rotation3D other) => !(Quaternion.Equals(other.Quaternion));
        ...
        [MethodImpl(AggressiveInlining)] public static Rotation3D Identity() => new Quaternion(0f, 0f, 0f, 1f);
