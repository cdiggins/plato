...
namespace Ara3D.Geometry
{
    ...
    public partial struct LookAt3D: IRotation3D
    {
        ...
        public Matrix4x4 Matrix { [MethodImpl(AggressiveInlining)] get  => Ara3D.Geometry.Matrix4x4.CreateWorld(((Number)(0f)), this.Target.Vector3().Subtract(this.Origin.Vector3()).Normalize(), Ara3D.Geometry.Vector3.UnitZ()); } 
        [MethodImpl(AggressiveInlining)] public static LookAt3D Identity() => (Constants.Origin3D(), Ara3D.Geometry.Vector3.UnitY());
