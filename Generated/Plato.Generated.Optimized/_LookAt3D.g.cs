...
namespace Ara3D.Geometry
{
    ...
    public partial struct LookAt3D: IRotation3D
    {
        ...
        [MethodImpl(AggressiveInlining)] public bool Equals(LookAt3D other) => Origin.Equals(other.Origin) && Target.Equals(other.Target);
        [MethodImpl(AggressiveInlining)] public bool NotEquals(LookAt3D other) => !(Origin.Equals(other.Origin) && Target.Equals(other.Target));
        [MethodImpl(AggressiveInlining)] public override bool Equals(object obj) => obj is LookAt3D other ? Equals(other) : false;
        ...
        public Matrix4x4 Matrix { [MethodImpl(AggressiveInlining)] get  => Ara3D.Geometry.Matrix4x4.CreateWorld(((Number)(0f)), new Vector3(((float)this.Target.X), ((float)this.Target.Y), ((float)this.Target.Z)).Subtract(new Vector3(((float)this.Origin.X), ((float)this.Origin.Y), ((float)this.Origin.Z))).Normalize(), new Vector3(0f, 0f, 1f)); } 
        [MethodImpl(AggressiveInlining)] public static LookAt3D Identity() => (Constants.Origin3D(), new Vector3(0f, 1f, 0f));
        ...
        [MethodImpl(AggressiveInlining)] public Vector3 Multiply(Vector3 v) => v.TransformNormal(this.Quaternion.Matrix);
        ...
        [MethodImpl(AggressiveInlining)] public Transform3D Transform3D() => this.Quaternion.Matrix;
        [MethodImpl(AggressiveInlining)]  public static implicit operator Transform3D(LookAt3D x) => x.Transform3D();
        [MethodImpl(AggressiveInlining)] public Matrix4x4 Matrix4x4() => this.Quaternion.Matrix;
