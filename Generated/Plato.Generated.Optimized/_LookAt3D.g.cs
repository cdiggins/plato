...
namespace Ara3D.Geometry
{
    ...
    public partial struct LookAt3D: IRotation3D
    {
        ...
        public Matrix4x4 Matrix { [MethodImpl(AggressiveInlining)] get  => Ara3D.Geometry.Matrix4x4.CreateWorld(((Number)0f), new Vector3(this.Target.X, this.Target.Y, this.Target.Z).Subtract(new Vector3(this.Origin.X, this.Origin.Y, this.Origin.Z)).Normalize(), new Vector3(0f, 0f, 1f)); } 
