...
namespace Ara3D.Geometry
{
    ...
    public partial struct Quad2D: IPolygon2D<Quad2D>, IArrayLike<Quad2D, Point2D>
    {
        ...
        [MethodImpl(AggressiveInlining)] public Quad3D Quad3D() => new Quad3D(new Point3D(((float)this.A.X), ((float)this.A.Y), 0), new Point3D(((float)this.B.X), ((float)this.B.Y), 0), new Point3D(((float)this.C.X), ((float)this.C.Y), 0), new Point3D(((float)this.D.X), ((float)this.D.Y), 0));
