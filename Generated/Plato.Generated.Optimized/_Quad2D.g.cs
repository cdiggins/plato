...
namespace Ara3D.Geometry
{
    ...
    public partial struct Quad2D: IPolygon2D<Quad2D>, IArrayLike<Quad2D, Point2D>
    {
        ...
        public Point2D Center { [MethodImpl(AggressiveInlining)] get  => this.A.Add(this.B).Add(this.C).Add(this.D).Divide(4f); } 
        public IReadOnlyList<Point2D> Points { [MethodImpl(AggressiveInlining)] get  => this.Components(); } 
        [MethodImpl(AggressiveInlining)] public Quad3D Quad3D() => new Quad3D(new Point3D(this.A.X, this.A.Y, 0), new Point3D(this.B.X, this.B.Y, 0), new Point3D(this.C.X, this.C.Y, 0), new Point3D(this.D.X, this.D.Y, 0));
        [MethodImpl(AggressiveInlining)]  public static implicit operator Quad3D(Quad2D x) => x.Quad3D();
        [MethodImpl(AggressiveInlining)] public static Quad2D Unit() => ((0f, 0f), (1f, 0f), (1f, 1f), (0f, 1f));
