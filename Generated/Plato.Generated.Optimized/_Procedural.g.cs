...
namespace Ara3D.Geometry
{
    ...
    public partial struct Procedural<TIn, TOut>
    {
        ...
        [MethodImpl(AggressiveInlining)] public bool Equals(Procedural<TIn, TOut> other) => Function.Equals(other.Function);
        [MethodImpl(AggressiveInlining)] public bool NotEquals(Procedural<TIn, TOut> other) => !(Function.Equals(other.Function));
