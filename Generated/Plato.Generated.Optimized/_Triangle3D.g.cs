...
namespace Ara3D.Geometry
{
    ...
    public partial struct Triangle3D: IDeformable3D<Triangle3D>, IArrayLike<Triangle3D, Point3D>
    {
        ...
        public Vector3 Normal { [MethodImpl(AggressiveInlining)] get  => this.B.Vector3().Subtract(this.A.Vector3()).Cross(this.C.Vector3().Subtract(this.A.Vector3())).Normalize(); } 
        public Point3D Center { [MethodImpl(AggressiveInlining)] get  => this.A.Add(this.B).Add(this.C).Divide(((float)(3f))); } 
        public Plane Plane { [MethodImpl(AggressiveInlining)] get  => (this.B.Vector3().Subtract(this.A.Vector3()).Cross(this.C.Vector3().Subtract(this.A.Vector3())).Normalize(), ((float)this.B.Vector3().Subtract(this.A.Vector3()).Cross(this.C.Vector3().Subtract(this.A.Vector3())).Normalize().Dot(this.A))); } 
