...
namespace Ara3D.Geometry
{
    ...
    public partial struct Triangle3D: IDeformable3D<Triangle3D>, IArrayLike<Triangle3D, Point3D>
    {
        ...
        public Vector3 Normal { [MethodImpl(AggressiveInlining)] get  => new Vector3(((float)this.B.X), ((float)this.B.Y), ((float)this.B.Z)).Subtract(new Vector3(((float)this.A.X), ((float)this.A.Y), ((float)this.A.Z))).Cross(new Vector3(((float)this.C.X), ((float)this.C.Y), ((float)this.C.Z)).Subtract(new Vector3(((float)this.A.X), ((float)this.A.Y), ((float)this.A.Z)))).Normalize(); } 
        public Point3D Center { [MethodImpl(AggressiveInlining)] get  => this.A.Add(this.B).Add(this.C).Divide(((float)(3f))); } 
        public Plane Plane { [MethodImpl(AggressiveInlining)] get  => (new Vector3(((float)this.B.X), ((float)this.B.Y), ((float)this.B.Z)).Subtract(new Vector3(((float)this.A.X), ((float)this.A.Y), ((float)this.A.Z))).Cross(new Vector3(((float)this.C.X), ((float)this.C.Y), ((float)this.C.Z)).Subtract(new Vector3(((float)this.A.X), ((float)this.A.Y), ((float)this.A.Z)))).Normalize(), ((float)new Vector3(((float)this.B.X), ((float)this.B.Y), ((float)this.B.Z)).Subtract(new Vector3(((float)this.A.X), ((float)this.A.Y), ((float)this.A.Z))).Cross(new Vector3(((float)this.C.X), ((float)this.C.Y), ((float)this.C.Z)).Subtract(new Vector3(((float)this.A.X), ((float)this.A.Y), ((float)this.A.Z)))).Normalize().Dot(this.A))); } 
        ...
        [MethodImpl(AggressiveInlining)] public Triangle3D Transform(Transform3D t){
            var _var9 = t;
            return this.Deform((p)  => new Vector3(((float)p.X), ((float)p.Y), ((float)p.Z)).Transform(_var9.Matrix));
        }
