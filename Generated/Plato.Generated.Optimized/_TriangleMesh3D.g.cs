...
namespace Ara3D.Geometry
{
    ...
    public partial struct TriangleMesh3D: IIndexedGeometry3D<TriangleMesh3D, Integer3>
    {
        ...
        [MethodImpl(AggressiveInlining)] public TriangleMesh3D Deform(System.Func<Point3D, Point3D> f){
            ...
            {
                _lp24[_i24] = f(_s24[_i24]);
            }
            return (_lp24, this.FaceIndices);
        }

        [MethodImpl(AggressiveInlining)] public TriangleMesh3D Transform(Transform3D t){
            var _var12 = t;
            {
                var _s25 = this.Points;
                var _n25 = _s25.Count;
                var _lp25 = new Point3D[_n25];
                for (var _i25 = 0; _i25 < _n25; _i25++)
                {
                    var p_25 = _s25[_i25];
                    _lp25[_i25] = new Vector3(((float)p_25.X), ((float)p_25.Y), ((float)p_25.Z)).Transform(t.Matrix);
                }
                return new TriangleMesh3D(_lp25, this.FaceIndices);
            }
        }
