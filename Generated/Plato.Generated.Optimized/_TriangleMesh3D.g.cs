...
namespace Ara3D.Geometry
{
    ...
    public partial struct TriangleMesh3D: IIndexedGeometry3D<TriangleMesh3D, Integer3>
    {
        ...
        [MethodImpl(AggressiveInlining)] public TriangleMesh3D Deform(System.Func<Point3D, Point3D> f){
            var _s18 = this.Points;
            var _n18 = _s18.Count;
            var _lp18 = new Point3D[_n18];
            for (var _i18 = 0; _i18 < _n18; _i18++)
            {
                _lp18[_i18] = f(_s18[_i18]);
            }
            return (_lp18, this.FaceIndices);
        }

        [MethodImpl(AggressiveInlining)] public TriangleMesh3D Transform(Transform3D t){
            var _var12 = t;
            {
                var _s19 = this.Points;
                var _n19 = _s19.Count;
                var _lp19 = new Point3D[_n19];
                for (var _i19 = 0; _i19 < _n19; _i19++)
                {
                    var p_13 = _s19[_i19];
                    _lp19[_i19] = new Vector3(((float)p_13.X), ((float)p_13.Y), ((float)p_13.Z)).Transform(t.Matrix);
                }
                return new TriangleMesh3D(_lp19, this.FaceIndices);
            }
        }
