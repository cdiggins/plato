...
namespace Ara3D.Geometry
{
    ...
    public partial struct Line2D: IArrayLike<Line2D, Point2D>, IInterval<Point2D>
    {
        ...
        public Point2D Center { [MethodImpl(AggressiveInlining)] get  => new Point2D(this.A.X.Multiply(1f.Subtract(0.5f)).Add(this.B.X.Multiply(0.5f)), this.A.Y.Multiply(1f.Subtract(0.5f)).Add(this.B.Y.Multiply(0.5f))); } 
        ...
        public IReadOnlyList<Point2D> Points { [MethodImpl(AggressiveInlining)] get  => Intrinsics.MakeArray<Point2D>(this.A, this.B); } 
