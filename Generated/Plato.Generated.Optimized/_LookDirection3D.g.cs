...
namespace Ara3D.Geometry
{
    ...
    public partial struct LookDirection3D: IRotation3D
    {
        ...
        [MethodImpl(AggressiveInlining)] public bool Equals(LookDirection3D other) => Direction.Equals(other.Direction);
        [MethodImpl(AggressiveInlining)] public bool NotEquals(LookDirection3D other) => !(Direction.Equals(other.Direction));
        [MethodImpl(AggressiveInlining)] public override bool Equals(object obj) => obj is LookDirection3D other ? Equals(other) : false;
        ...
        public Matrix4x4 Matrix { [MethodImpl(AggressiveInlining)] get  => Ara3D.Geometry.Matrix4x4.CreateWorld(((Number)(0f)), this.Direction, Ara3D.Geometry.Vector3.UnitZ()); } 
        [MethodImpl(AggressiveInlining)] public static LookDirection3D Identity() => Ara3D.Geometry.Vector3.UnitY();
