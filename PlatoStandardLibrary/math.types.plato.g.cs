...
namespace Plato
{
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<float> Add(this IEnumerable<float> self, IEnumerable<float> other) =>
            self.Zip(other, (a, b) => a + b);

        public static float Subtract(this float a, float b) => a - b;

        public static IEnumerable<float> Subtract(this IEnumerable<float> self, IEnumerable<float> other) =>
            self.Zip(other, (a, b) => a - b);
        ...
        public static IEnumerable<float> Multiply(this IEnumerable<float> self, IEnumerable<float> other) =>
            self.Zip(other, (a, b) => a * b);

        public static float Divide(this float a, float b) => a / b;

        public static IEnumerable<float> Divide(this IEnumerable<float> self, IEnumerable<float> other) =>
            self.Zip(other, (a, b) => a / b);

        public static float Modulo(this float a, float b) => a % b;

        public static IEnumerable<float> Modulo(this IEnumerable<float> self, IEnumerable<float> other) =>
            self.Zip(other, (a, b) => a % b);
        ...
        public static IEnumerable<int> CompareTo(this IEnumerable<float> self, IEnumerable<float> other) =>
            self.Zip(other, (a, b) => a.CompareTo(b));

        public static bool LessThan(this float a, float b) => a < b;

        public static IEnumerable<bool> LessThan(this IEnumerable<float> self, IEnumerable<float> other) =>
            self.Zip(other, (a, b) => a < b);

        public static bool LessThanOrEquals(this float a, float b) => a <= b;

        public static IEnumerable<bool> LessThanOrEquals(this IEnumerable<float> self, IEnumerable<float> other) =>
            self.Zip(other, (a, b) => a <= b);

        public static bool GreaterThan(this float a, float b) => a > b;

        public static IEnumerable<bool> GreaterThan(this IEnumerable<float> self, IEnumerable<float> other) =>
            self.Zip(other, (a, b) => a > b);

        public static bool GreaterThanOrEquals(this float a, float b) => a >= b;

        public static IEnumerable<bool> GreaterThanOrEquals(this IEnumerable<float> self, IEnumerable<float> other) =>
            self.Zip(other, (a, b) => a >= b);
    ...
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<double> Add(this IEnumerable<double> self, IEnumerable<double> other) =>
            self.Zip(other, (a, b) => a + b);

        public static double Subtract(this double a, double b) => a - b;

        public static IEnumerable<double> Subtract(this IEnumerable<double> self, IEnumerable<double> other) =>
            self.Zip(other, (a, b) => a - b);
        ...
        public static IEnumerable<double> Multiply(this IEnumerable<double> self, IEnumerable<double> other) =>
            self.Zip(other, (a, b) => a * b);

        public static double Divide(this double a, double b) => a / b;

        public static IEnumerable<double> Divide(this IEnumerable<double> self, IEnumerable<double> other) =>
            self.Zip(other, (a, b) => a / b);

        public static double Modulo(this double a, double b) => a % b;

        public static IEnumerable<double> Modulo(this IEnumerable<double> self, IEnumerable<double> other) =>
            self.Zip(other, (a, b) => a % b);
        ...
        public static IEnumerable<int> CompareTo(this IEnumerable<double> self, IEnumerable<double> other) =>
            self.Zip(other, (a, b) => a.CompareTo(b));

        public static bool LessThan(this double a, double b) => a < b;

        public static IEnumerable<bool> LessThan(this IEnumerable<double> self, IEnumerable<double> other) =>
            self.Zip(other, (a, b) => a < b);

        public static bool LessThanOrEquals(this double a, double b) => a <= b;

        public static IEnumerable<bool> LessThanOrEquals(this IEnumerable<double> self, IEnumerable<double> other) =>
            self.Zip(other, (a, b) => a <= b);

        public static bool GreaterThan(this double a, double b) => a > b;

        public static IEnumerable<bool> GreaterThan(this IEnumerable<double> self, IEnumerable<double> other) =>
            self.Zip(other, (a, b) => a > b);

        public static bool GreaterThanOrEquals(this double a, double b) => a >= b;

        public static IEnumerable<bool> GreaterThanOrEquals(this IEnumerable<double> self, IEnumerable<double> other) =>
            self.Zip(other, (a, b) => a >= b);
    ...
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<int> Add(this IEnumerable<int> self, IEnumerable<int> other) =>
            self.Zip(other, (a, b) => a + b);

        public static int Subtract(this int a, int b) => a - b;

        public static IEnumerable<int> Subtract(this IEnumerable<int> self, IEnumerable<int> other) =>
            self.Zip(other, (a, b) => a - b);

        public static int Sum(this IEnumerable<int> self) => self.Aggregate((a, b) => a + b);
        public static int Multiply(this int a, int b) => a * b;

        public static IEnumerable<int> Multiply(this IEnumerable<int> self, IEnumerable<int> other) =>
            self.Zip(other, (a, b) => a * b);

        public static int Divide(this int a, int b) => a / b;

        public static IEnumerable<int> Divide(this IEnumerable<int> self, IEnumerable<int> other) =>
            self.Zip(other, (a, b) => a / b);

        public static int Modulo(this int a, int b) => a % b;

        public static IEnumerable<int> Modulo(this IEnumerable<int> self, IEnumerable<int> other) =>
            self.Zip(other, (a, b) => a % b);
        ...
        public static IEnumerable<int> CompareTo(this IEnumerable<int> self, IEnumerable<int> other) =>
            self.Zip(other, (a, b) => a.CompareTo(b));

        public static bool LessThan(this int a, int b) => a < b;

        public static IEnumerable<bool> LessThan(this IEnumerable<int> self, IEnumerable<int> other) =>
            self.Zip(other, (a, b) => a < b);

        public static bool LessThanOrEquals(this int a, int b) => a <= b;

        public static IEnumerable<bool> LessThanOrEquals(this IEnumerable<int> self, IEnumerable<int> other) =>
            self.Zip(other, (a, b) => a <= b);

        public static bool GreaterThan(this int a, int b) => a > b;

        public static IEnumerable<bool> GreaterThan(this IEnumerable<int> self, IEnumerable<int> other) =>
            self.Zip(other, (a, b) => a > b);

        public static bool GreaterThanOrEquals(this int a, int b) => a >= b;

        public static IEnumerable<bool> GreaterThanOrEquals(this IEnumerable<int> self, IEnumerable<int> other) =>
            self.Zip(other, (a, b) => a >= b);
    ...
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<long> Add(this IEnumerable<long> self, IEnumerable<long> other) =>
            self.Zip(other, (a, b) => a + b);

        public static long Subtract(this long a, long b) => a - b;

        public static IEnumerable<long> Subtract(this IEnumerable<long> self, IEnumerable<long> other) =>
            self.Zip(other, (a, b) => a - b);
        ...
        public static IEnumerable<long> Multiply(this IEnumerable<long> self, IEnumerable<long> other) =>
            self.Zip(other, (a, b) => a * b);

        public static long Divide(this long a, long b) => a / b;

        public static IEnumerable<long> Divide(this IEnumerable<long> self, IEnumerable<long> other) =>
            self.Zip(other, (a, b) => a / b);

        public static long Modulo(this long a, long b) => a % b;

        public static IEnumerable<long> Modulo(this IEnumerable<long> self, IEnumerable<long> other) =>
            self.Zip(other, (a, b) => a % b);
        ...
        public static IEnumerable<int> CompareTo(this IEnumerable<long> self, IEnumerable<long> other) =>
            self.Zip(other, (a, b) => a.CompareTo(b));

        public static bool LessThan(this long a, long b) => a < b;

        public static IEnumerable<bool> LessThan(this IEnumerable<long> self, IEnumerable<long> other) =>
            self.Zip(other, (a, b) => a < b);

        public static bool LessThanOrEquals(this long a, long b) => a <= b;

        public static IEnumerable<bool> LessThanOrEquals(this IEnumerable<long> self, IEnumerable<long> other) =>
            self.Zip(other, (a, b) => a <= b);

        public static bool GreaterThan(this long a, long b) => a > b;

        public static IEnumerable<bool> GreaterThan(this IEnumerable<long> self, IEnumerable<long> other) =>
            self.Zip(other, (a, b) => a > b);

        public static bool GreaterThanOrEquals(this long a, long b) => a >= b;

        public static IEnumerable<bool> GreaterThanOrEquals(this IEnumerable<long> self, IEnumerable<long> other) =>
            self.Zip(other, (a, b) => a >= b);
    ...
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<decimal> Add(this IEnumerable<decimal> self, IEnumerable<decimal> other) =>
            self.Zip(other, (a, b) => a + b);

        public static decimal Subtract(this decimal a, decimal b) => a - b;

        public static IEnumerable<decimal> Subtract(this IEnumerable<decimal> self, IEnumerable<decimal> other) =>
            self.Zip(other, (a, b) => a - b);
        ...
        public static IEnumerable<decimal> Multiply(this IEnumerable<decimal> self, IEnumerable<decimal> other) =>
            self.Zip(other, (a, b) => a * b);

        public static decimal Divide(this decimal a, decimal b) => a / b;

        public static IEnumerable<decimal> Divide(this IEnumerable<decimal> self, IEnumerable<decimal> other) =>
            self.Zip(other, (a, b) => a / b);

        public static decimal Modulo(this decimal a, decimal b) => a % b;

        public static IEnumerable<decimal> Modulo(this IEnumerable<decimal> self, IEnumerable<decimal> other) =>
            self.Zip(other, (a, b) => a % b);
        ...
        public static IEnumerable<int> CompareTo(this IEnumerable<decimal> self, IEnumerable<decimal> other) =>
            self.Zip(other, (a, b) => a.CompareTo(b));

        public static bool LessThan(this decimal a, decimal b) => a < b;

        public static IEnumerable<bool> LessThan(this IEnumerable<decimal> self, IEnumerable<decimal> other) =>
            self.Zip(other, (a, b) => a < b);

        public static bool LessThanOrEquals(this decimal a, decimal b) => a <= b;

        public static IEnumerable<bool> LessThanOrEquals(this IEnumerable<decimal> self, IEnumerable<decimal> other) =>
            self.Zip(other, (a, b) => a <= b);

        public static bool GreaterThan(this decimal a, decimal b) => a > b;

        public static IEnumerable<bool> GreaterThan(this IEnumerable<decimal> self, IEnumerable<decimal> other) =>
            self.Zip(other, (a, b) => a > b);

        public static bool GreaterThanOrEquals(this decimal a, decimal b) => a >= b;

        public static IEnumerable<bool>
            GreaterThanOrEquals(this IEnumerable<decimal> self, IEnumerable<decimal> other) =>
            self.Zip(other, (a, b) => a >= b);
    ...
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<Float2> Add(this IEnumerable<Float2> self, IEnumerable<Float2> other) =>
            self.Zip(other, (a, b) => a + b);

        public static Float2 Subtract(this Float2 a, Float2 b) => a - b;

        public static IEnumerable<Float2> Subtract(this IEnumerable<Float2> self, IEnumerable<Float2> other) =>
            self.Zip(other, (a, b) => a - b);
        ...
        public static IEnumerable<Float2> Multiply(this IEnumerable<Float2> self, IEnumerable<Float2> other) =>
            self.Zip(other, (a, b) => a * b);

        public static Float2 Divide(this Float2 a, Float2 b) => a / b;

        public static IEnumerable<Float2> Divide(this IEnumerable<Float2> self, IEnumerable<Float2> other) =>
            self.Zip(other, (a, b) => a / b);

        public static Float2 Modulo(this Float2 a, Float2 b) => a % b;

        public static IEnumerable<Float2> Modulo(this IEnumerable<Float2> self, IEnumerable<Float2> other) =>
            self.Zip(other, (a, b) => a % b);
    ...
    public partial struct Float3
    {
        ...
        public static Float3 operator *(Float3 self, Float scalar) =>
            new Float3(self.X * scalar, self.Y * scalar, self.Z * scalar);
    ...
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<Float3> Add(this IEnumerable<Float3> self, IEnumerable<Float3> other) =>
            self.Zip(other, (a, b) => a + b);

        public static Float3 Subtract(this Float3 a, Float3 b) => a - b;

        public static IEnumerable<Float3> Subtract(this IEnumerable<Float3> self, IEnumerable<Float3> other) =>
            self.Zip(other, (a, b) => a - b);
        ...
        public static IEnumerable<Float3> Multiply(this IEnumerable<Float3> self, IEnumerable<Float3> other) =>
            self.Zip(other, (a, b) => a * b);

        public static Float3 Divide(this Float3 a, Float3 b) => a / b;

        public static IEnumerable<Float3> Divide(this IEnumerable<Float3> self, IEnumerable<Float3> other) =>
            self.Zip(other, (a, b) => a / b);

        public static Float3 Modulo(this Float3 a, Float3 b) => a % b;

        public static IEnumerable<Float3> Modulo(this IEnumerable<Float3> self, IEnumerable<Float3> other) =>
            self.Zip(other, (a, b) => a % b);
    ...
    public partial struct Float4
    {
        ...
        public static implicit operator (Float X, Float Y, Float Z, Float W)(Float4 self) =>
        ...
        public static Float4 MinValue = new Float4(Default.X.MinValue(), Default.Y.MinValue(), Default.Z.MinValue(),
            Default.W.MinValue());

        public static Float4 MaxValue = new Float4(Default.X.MaxValue(), Default.Y.MaxValue(), Default.Z.MaxValue(),
            Default.W.MaxValue());
        ...
        public static Float4 operator *(Float4 self, Float scalar) =>
            new Float4(self.X * scalar, self.Y * scalar, self.Z * scalar, self.W * scalar);
    ...
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<Float4> Add(this IEnumerable<Float4> self, IEnumerable<Float4> other) =>
            self.Zip(other, (a, b) => a + b);

        public static Float4 Subtract(this Float4 a, Float4 b) => a - b;

        public static IEnumerable<Float4> Subtract(this IEnumerable<Float4> self, IEnumerable<Float4> other) =>
            self.Zip(other, (a, b) => a - b);
        ...
        public static IEnumerable<Float4> Multiply(this IEnumerable<Float4> self, IEnumerable<Float4> other) =>
            self.Zip(other, (a, b) => a * b);

        public static Float4 Divide(this Float4 a, Float4 b) => a / b;

        public static IEnumerable<Float4> Divide(this IEnumerable<Float4> self, IEnumerable<Float4> other) =>
            self.Zip(other, (a, b) => a / b);

        public static Float4 Modulo(this Float4 a, Float4 b) => a % b;

        public static IEnumerable<Float4> Modulo(this IEnumerable<Float4> self, IEnumerable<Float4> other) =>
            self.Zip(other, (a, b) => a % b);
    ...
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<Double2> Add(this IEnumerable<Double2> self, IEnumerable<Double2> other) =>
            self.Zip(other, (a, b) => a + b);

        public static Double2 Subtract(this Double2 a, Double2 b) => a - b;

        public static IEnumerable<Double2> Subtract(this IEnumerable<Double2> self, IEnumerable<Double2> other) =>
            self.Zip(other, (a, b) => a - b);
        ...
        public static IEnumerable<Double2> Multiply(this IEnumerable<Double2> self, IEnumerable<Double2> other) =>
            self.Zip(other, (a, b) => a * b);

        public static Double2 Divide(this Double2 a, Double2 b) => a / b;

        public static IEnumerable<Double2> Divide(this IEnumerable<Double2> self, IEnumerable<Double2> other) =>
            self.Zip(other, (a, b) => a / b);

        public static Double2 Modulo(this Double2 a, Double2 b) => a % b;

        public static IEnumerable<Double2> Modulo(this IEnumerable<Double2> self, IEnumerable<Double2> other) =>
            self.Zip(other, (a, b) => a % b);
    ...
    public partial struct Double3
    {
        ...
        public static implicit operator Double3((Double X, Double Y, Double Z) tuple) =>
            new Double3(tuple.X, tuple.Y, tuple.Z);
        ...
        public static Double3 operator *(Double3 self, Double scalar) =>
            new Double3(self.X * scalar, self.Y * scalar, self.Z * scalar);
    ...
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<Double3> Add(this IEnumerable<Double3> self, IEnumerable<Double3> other) =>
            self.Zip(other, (a, b) => a + b);

        public static Double3 Subtract(this Double3 a, Double3 b) => a - b;

        public static IEnumerable<Double3> Subtract(this IEnumerable<Double3> self, IEnumerable<Double3> other) =>
            self.Zip(other, (a, b) => a - b);
        ...
        public static IEnumerable<Double3> Multiply(this IEnumerable<Double3> self, IEnumerable<Double3> other) =>
            self.Zip(other, (a, b) => a * b);

        public static Double3 Divide(this Double3 a, Double3 b) => a / b;

        public static IEnumerable<Double3> Divide(this IEnumerable<Double3> self, IEnumerable<Double3> other) =>
            self.Zip(other, (a, b) => a / b);

        public static Double3 Modulo(this Double3 a, Double3 b) => a % b;

        public static IEnumerable<Double3> Modulo(this IEnumerable<Double3> self, IEnumerable<Double3> other) =>
            self.Zip(other, (a, b) => a % b);
    ...
    public partial struct Double4
    {
        ...
        public static implicit operator Double4((Double X, Double Y, Double Z, Double W) tuple) =>
            new Double4(tuple.X, tuple.Y, tuple.Z, tuple.W);

        public static implicit operator (Double X, Double Y, Double Z, Double W)(Double4 self) =>
            (self.X, self.Y, self.Z, self.W);
        ...
        public static Double4 Zero = new Double4(Default.X.Zero(), Default.Y.Zero(), Default.Z.Zero(),
            Default.W.Zero());

        public static Double4 One = new Double4(Default.X.One(), Default.Y.One(), Default.Z.One(), Default.W.One());

        public static Double4 MinValue = new Double4(Default.X.MinValue(), Default.Y.MinValue(), Default.Z.MinValue(),
            Default.W.MinValue());

        public static Double4 MaxValue = new Double4(Default.X.MaxValue(), Default.Y.MaxValue(), Default.Z.MaxValue(),
            Default.W.MaxValue());
        ...
        public static Double4 operator *(Double4 self, Double scalar) =>
            new Double4(self.X * scalar, self.Y * scalar, self.Z * scalar, self.W * scalar);
    ...
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<Double4> Add(this IEnumerable<Double4> self, IEnumerable<Double4> other) =>
            self.Zip(other, (a, b) => a + b);

        public static Double4 Subtract(this Double4 a, Double4 b) => a - b;

        public static IEnumerable<Double4> Subtract(this IEnumerable<Double4> self, IEnumerable<Double4> other) =>
            self.Zip(other, (a, b) => a - b);
        ...
        public static IEnumerable<Double4> Multiply(this IEnumerable<Double4> self, IEnumerable<Double4> other) =>
            self.Zip(other, (a, b) => a * b);

        public static Double4 Divide(this Double4 a, Double4 b) => a / b;

        public static IEnumerable<Double4> Divide(this IEnumerable<Double4> self, IEnumerable<Double4> other) =>
            self.Zip(other, (a, b) => a / b);

        public static Double4 Modulo(this Double4 a, Double4 b) => a % b;

        public static IEnumerable<Double4> Modulo(this IEnumerable<Double4> self, IEnumerable<Double4> other) =>
            self.Zip(other, (a, b) => a % b);
    ...
    public partial struct Quaternion
    {
        ...
        public static implicit operator Quaternion((Double X, Double Y, Double Z, Double W) tuple) =>
            new Quaternion(tuple.X, tuple.Y, tuple.Z, tuple.W);

        public static implicit operator (Double X, Double Y, Double Z, Double W)(Quaternion self) =>
            (self.X, self.Y, self.Z, self.W);
        ...
        public static Quaternion Zero =
            new Quaternion(Default.X.Zero(), Default.Y.Zero(), Default.Z.Zero(), Default.W.Zero());

        public static Quaternion One = new Quaternion(Default.X.One(), Default.Y.One(), Default.Z.One(),
            Default.W.One());

        public static Quaternion MinValue = new Quaternion(Default.X.MinValue(), Default.Y.MinValue(),
            Default.Z.MinValue(), Default.W.MinValue());

        public static Quaternion MaxValue = new Quaternion(Default.X.MaxValue(), Default.Y.MaxValue(),
            Default.Z.MaxValue(), Default.W.MaxValue());
    ...
    public partial struct AxisAngle
    {
        ...
        public static implicit operator AxisAngle((Double3 Axis, Angle Angle) tuple) =>
            new AxisAngle(tuple.Axis, tuple.Angle);
    ...
    public partial struct EulerAngles
    {
        ...
        public static implicit operator EulerAngles((Angle Yaw, Angle Pitch, Angle Roll) tuple) =>
            new EulerAngles(tuple.Yaw, tuple.Pitch, tuple.Roll);

        public static implicit operator (Angle Yaw, Angle Pitch, Angle Roll)(EulerAngles self) =>
        ...
        public static EulerAngles MinValue =
            new EulerAngles(Default.Yaw.MinValue(), Default.Pitch.MinValue(), Default.Roll.MinValue());

        public static EulerAngles MaxValue =
            new EulerAngles(Default.Yaw.MaxValue(), Default.Pitch.MaxValue(), Default.Roll.MaxValue());
    ...
    public partial struct Byte2
    {
        ...
        public static implicit operator Byte2((Byte A, Byte B, Byte C, Byte D) tuple) =>
            new Byte2(tuple.A, tuple.B, tuple.C, tuple.D);

        public static implicit operator (Byte A, Byte B, Byte C, Byte D)(Byte2 self) =>
        ...
        public static Byte2 MinValue = new Byte2(Default.A.MinValue(), Default.B.MinValue(), Default.C.MinValue(),
            Default.D.MinValue());

        public static Byte2 MaxValue = new Byte2(Default.A.MaxValue(), Default.B.MaxValue(), Default.C.MaxValue(),
            Default.D.MaxValue());
    ...
    public partial struct Byte3
    {
        ...
        public static implicit operator Byte3((Byte A, Byte B, Byte C, Byte D) tuple) =>
            new Byte3(tuple.A, tuple.B, tuple.C, tuple.D);

        public static implicit operator (Byte A, Byte B, Byte C, Byte D)(Byte3 self) =>
            (self.A, self.B, self.C, self.D);
    ...
    public partial struct Byte4
    {
        ...
        public static implicit operator Byte4((Byte A, Byte B, Byte C, Byte D) tuple) =>
            new Byte4(tuple.A, tuple.B, tuple.C, tuple.D);

        public static implicit operator (Byte A, Byte B, Byte C, Byte D)(Byte4 self) =>
            (self.A, self.B, self.C, self.D);
        ...
        public static Byte4 MinValue = new Byte4(Default.A.MinValue(), Default.B.MinValue(), Default.C.MinValue(),
            Default.D.MinValue());

        public static Byte4 MaxValue = new Byte4(Default.A.MaxValue(), Default.B.MaxValue(), Default.C.MaxValue(),
            Default.D.MaxValue());
    ...
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<Int2> Add(this IEnumerable<Int2> self, IEnumerable<Int2> other) =>
            self.Zip(other, (a, b) => a + b);

        public static Int2 Subtract(this Int2 a, Int2 b) => a - b;

        public static IEnumerable<Int2> Subtract(this IEnumerable<Int2> self, IEnumerable<Int2> other) =>
            self.Zip(other, (a, b) => a - b);
        ...
        public static IEnumerable<Int2> Multiply(this IEnumerable<Int2> self, IEnumerable<Int2> other) =>
            self.Zip(other, (a, b) => a * b);

        public static Int2 Divide(this Int2 a, Int2 b) => a / b;

        public static IEnumerable<Int2> Divide(this IEnumerable<Int2> self, IEnumerable<Int2> other) =>
            self.Zip(other, (a, b) => a / b);

        public static Int2 Modulo(this Int2 a, Int2 b) => a % b;

        public static IEnumerable<Int2> Modulo(this IEnumerable<Int2> self, IEnumerable<Int2> other) =>
            self.Zip(other, (a, b) => a % b);
    ...
    public partial struct Int3
    {
        ...
        public static Int3 operator *(Int3 self, Int scalar) =>
            new Int3(self.A * scalar, self.B * scalar, self.C * scalar);
    ...
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<Int3> Add(this IEnumerable<Int3> self, IEnumerable<Int3> other) =>
            self.Zip(other, (a, b) => a + b);

        public static Int3 Subtract(this Int3 a, Int3 b) => a - b;

        public static IEnumerable<Int3> Subtract(this IEnumerable<Int3> self, IEnumerable<Int3> other) =>
            self.Zip(other, (a, b) => a - b);
        ...
        public static IEnumerable<Int3> Multiply(this IEnumerable<Int3> self, IEnumerable<Int3> other) =>
            self.Zip(other, (a, b) => a * b);

        public static Int3 Divide(this Int3 a, Int3 b) => a / b;

        public static IEnumerable<Int3> Divide(this IEnumerable<Int3> self, IEnumerable<Int3> other) =>
            self.Zip(other, (a, b) => a / b);

        public static Int3 Modulo(this Int3 a, Int3 b) => a % b;

        public static IEnumerable<Int3> Modulo(this IEnumerable<Int3> self, IEnumerable<Int3> other) =>
            self.Zip(other, (a, b) => a % b);
    ...
    public partial struct Int4
    {
        ...
        public static implicit operator Int4((Int A, Int B, Int C, Int D) tuple) =>
            new Int4(tuple.A, tuple.B, tuple.C, tuple.D);
        ...
        public static Int4 MinValue = new Int4(Default.A.MinValue(), Default.B.MinValue(), Default.C.MinValue(),
            Default.D.MinValue());

        public static Int4 MaxValue = new Int4(Default.A.MaxValue(), Default.B.MaxValue(), Default.C.MaxValue(),
            Default.D.MaxValue());
        ...
        public static Int4 operator *(Int4 self, Int scalar) =>
            new Int4(self.A * scalar, self.B * scalar, self.C * scalar, self.D * scalar);
    ...
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<Int4> Add(this IEnumerable<Int4> self, IEnumerable<Int4> other) =>
            self.Zip(other, (a, b) => a + b);

        public static Int4 Subtract(this Int4 a, Int4 b) => a - b;

        public static IEnumerable<Int4> Subtract(this IEnumerable<Int4> self, IEnumerable<Int4> other) =>
            self.Zip(other, (a, b) => a - b);
        ...
        public static IEnumerable<Int4> Multiply(this IEnumerable<Int4> self, IEnumerable<Int4> other) =>
            self.Zip(other, (a, b) => a * b);

        public static Int4 Divide(this Int4 a, Int4 b) => a / b;

        public static IEnumerable<Int4> Divide(this IEnumerable<Int4> self, IEnumerable<Int4> other) =>
            self.Zip(other, (a, b) => a / b);

        public static Int4 Modulo(this Int4 a, Int4 b) => a % b;

        public static IEnumerable<Int4> Modulo(this IEnumerable<Int4> self, IEnumerable<Int4> other) =>
            self.Zip(other, (a, b) => a % b);
    ...
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<Long2> Add(this IEnumerable<Long2> self, IEnumerable<Long2> other) =>
            self.Zip(other, (a, b) => a + b);

        public static Long2 Subtract(this Long2 a, Long2 b) => a - b;

        public static IEnumerable<Long2> Subtract(this IEnumerable<Long2> self, IEnumerable<Long2> other) =>
            self.Zip(other, (a, b) => a - b);
        ...
        public static IEnumerable<Long2> Multiply(this IEnumerable<Long2> self, IEnumerable<Long2> other) =>
            self.Zip(other, (a, b) => a * b);

        public static Long2 Divide(this Long2 a, Long2 b) => a / b;

        public static IEnumerable<Long2> Divide(this IEnumerable<Long2> self, IEnumerable<Long2> other) =>
            self.Zip(other, (a, b) => a / b);

        public static Long2 Modulo(this Long2 a, Long2 b) => a % b;

        public static IEnumerable<Long2> Modulo(this IEnumerable<Long2> self, IEnumerable<Long2> other) =>
            self.Zip(other, (a, b) => a % b);
    ...
    public partial struct Long3
    {
        ...
        public static Long3 operator *(Long3 self, Long scalar) =>
            new Long3(self.A * scalar, self.B * scalar, self.C * scalar);
    ...
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<Long3> Add(this IEnumerable<Long3> self, IEnumerable<Long3> other) =>
            self.Zip(other, (a, b) => a + b);

        public static Long3 Subtract(this Long3 a, Long3 b) => a - b;

        public static IEnumerable<Long3> Subtract(this IEnumerable<Long3> self, IEnumerable<Long3> other) =>
            self.Zip(other, (a, b) => a - b);
        ...
        public static IEnumerable<Long3> Multiply(this IEnumerable<Long3> self, IEnumerable<Long3> other) =>
            self.Zip(other, (a, b) => a * b);

        public static Long3 Divide(this Long3 a, Long3 b) => a / b;

        public static IEnumerable<Long3> Divide(this IEnumerable<Long3> self, IEnumerable<Long3> other) =>
            self.Zip(other, (a, b) => a / b);

        public static Long3 Modulo(this Long3 a, Long3 b) => a % b;

        public static IEnumerable<Long3> Modulo(this IEnumerable<Long3> self, IEnumerable<Long3> other) =>
            self.Zip(other, (a, b) => a % b);
    ...
    public partial struct Long4
    {
        ...
        public static implicit operator Long4((Long A, Long B, Long C, Long D) tuple) =>
            new Long4(tuple.A, tuple.B, tuple.C, tuple.D);

        public static implicit operator (Long A, Long B, Long C, Long D)(Long4 self) =>
            (self.A, self.B, self.C, self.D);
        ...
        public static Long4 MinValue = new Long4(Default.A.MinValue(), Default.B.MinValue(), Default.C.MinValue(),
            Default.D.MinValue());

        public static Long4 MaxValue = new Long4(Default.A.MaxValue(), Default.B.MaxValue(), Default.C.MaxValue(),
            Default.D.MaxValue());
        ...
        public static Long4 operator *(Long4 self, Long scalar) =>
            new Long4(self.A * scalar, self.B * scalar, self.C * scalar, self.D * scalar);
    ...
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<Long4> Add(this IEnumerable<Long4> self, IEnumerable<Long4> other) =>
            self.Zip(other, (a, b) => a + b);

        public static Long4 Subtract(this Long4 a, Long4 b) => a - b;

        public static IEnumerable<Long4> Subtract(this IEnumerable<Long4> self, IEnumerable<Long4> other) =>
            self.Zip(other, (a, b) => a - b);
        ...
        public static IEnumerable<Long4> Multiply(this IEnumerable<Long4> self, IEnumerable<Long4> other) =>
            self.Zip(other, (a, b) => a * b);

        public static Long4 Divide(this Long4 a, Long4 b) => a / b;

        public static IEnumerable<Long4> Divide(this IEnumerable<Long4> self, IEnumerable<Long4> other) =>
            self.Zip(other, (a, b) => a / b);

        public static Long4 Modulo(this Long4 a, Long4 b) => a % b;

        public static IEnumerable<Long4> Modulo(this IEnumerable<Long4> self, IEnumerable<Long4> other) =>
            self.Zip(other, (a, b) => a % b);
    ...
    public partial struct Pose
    {
        ...
        public static implicit operator Pose((Double3 Position, Rotation Orientation) tuple) =>
            new Pose(tuple.Position, tuple.Orientation);

        public static implicit operator (Double3 Position, Rotation Orientation)(Pose self) =>
            (self.Position, self.Orientation);

        public void Deconstruct(out Double3 position, out Rotation orientation) =>
    ...
    {
        public Transform(Double3 translation, Rotation rotation, Double3 scale) =>
        ...
        public static implicit operator Transform((Double3 Translation, Rotation Rotation, Double3 Scale) tuple) =>
            new Transform(tuple.Translation, tuple.Rotation, tuple.Scale);

        public static implicit operator (Double3 Translation, Rotation Rotation, Double3 Scale)(Transform self) =>
            (self.Translation, self.Rotation, self.Scale);

        public void Deconstruct(out Double3 translation, out Rotation rotation, out Double3 scale) =>
            (translation, rotation, scale) = (Translation, Rotation, Scale);
        ...
        public static Transform Zero =
            new Transform(Default.Translation.Zero(), Default.Rotation.Zero(), Default.Scale.Zero());

        public static Transform One = new Transform(Default.Translation.One(), Default.Rotation.One(),
            Default.Scale.One());

        public static Transform MinValue = new Transform(Default.Translation.MinValue(), Default.Rotation.MinValue(),
            Default.Scale.MinValue());

        public static Transform MaxValue = new Transform(Default.Translation.MaxValue(), Default.Rotation.MaxValue(),
            Default.Scale.MaxValue());

        public static bool operator ==(Transform a, Transform b) => (a.Translation == b.Translation) &&
    ...
    public partial struct AABBox2D
    {
        ...
        public static AABBox2D operator *(AABBox2D self, Double2 scalar) =>
            new AABBox2D(self.A * scalar, self.B * scalar);
    ...
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<AABBox2D> Add(this IEnumerable<AABBox2D> self, IEnumerable<AABBox2D> other) =>
            self.Zip(other, (a, b) => a + b);

        public static AABBox2D Subtract(this AABBox2D a, AABBox2D b) => a - b;

        public static IEnumerable<AABBox2D> Subtract(this IEnumerable<AABBox2D> self, IEnumerable<AABBox2D> other) =>
            self.Zip(other, (a, b) => a - b);
        ...
        public static IEnumerable<AABBox2D> Multiply(this IEnumerable<AABBox2D> self, IEnumerable<AABBox2D> other) =>
            self.Zip(other, (a, b) => a * b);

        public static AABBox2D Divide(this AABBox2D a, AABBox2D b) => a / b;

        public static IEnumerable<AABBox2D> Divide(this IEnumerable<AABBox2D> self, IEnumerable<AABBox2D> other) =>
            self.Zip(other, (a, b) => a / b);

        public static AABBox2D Modulo(this AABBox2D a, AABBox2D b) => a % b;

        public static IEnumerable<AABBox2D> Modulo(this IEnumerable<AABBox2D> self, IEnumerable<AABBox2D> other) =>
            self.Zip(other, (a, b) => a % b);
    ...
    public partial struct AABBox3D
    {
        ...
        public static AABBox3D operator *(AABBox3D self, Double3 scalar) =>
            new AABBox3D(self.A * scalar, self.B * scalar);
    ...
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<AABBox3D> Add(this IEnumerable<AABBox3D> self, IEnumerable<AABBox3D> other) =>
            self.Zip(other, (a, b) => a + b);

        public static AABBox3D Subtract(this AABBox3D a, AABBox3D b) => a - b;

        public static IEnumerable<AABBox3D> Subtract(this IEnumerable<AABBox3D> self, IEnumerable<AABBox3D> other) =>
            self.Zip(other, (a, b) => a - b);
        ...
        public static IEnumerable<AABBox3D> Multiply(this IEnumerable<AABBox3D> self, IEnumerable<AABBox3D> other) =>
            self.Zip(other, (a, b) => a * b);

        public static AABBox3D Divide(this AABBox3D a, AABBox3D b) => a / b;

        public static IEnumerable<AABBox3D> Divide(this IEnumerable<AABBox3D> self, IEnumerable<AABBox3D> other) =>
            self.Zip(other, (a, b) => a / b);

        public static AABBox3D Modulo(this AABBox3D a, AABBox3D b) => a % b;

        public static IEnumerable<AABBox3D> Modulo(this IEnumerable<AABBox3D> self, IEnumerable<AABBox3D> other) =>
            self.Zip(other, (a, b) => a % b);
    ...
    public partial struct Complex
    {
        ...
        public static implicit operator Complex((Double Real, Double Imaginary) tuple) =>
            new Complex(tuple.Real, tuple.Imaginary);
        ...
        public static Complex operator *(Complex self, Double scalar) =>
            new Complex(self.Real * scalar, self.Imaginary * scalar);
    ...
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<Complex> Add(this IEnumerable<Complex> self, IEnumerable<Complex> other) =>
            self.Zip(other, (a, b) => a + b);

        public static Complex Subtract(this Complex a, Complex b) => a - b;

        public static IEnumerable<Complex> Subtract(this IEnumerable<Complex> self, IEnumerable<Complex> other) =>
            self.Zip(other, (a, b) => a - b);
        ...
        public static IEnumerable<Complex> Multiply(this IEnumerable<Complex> self, IEnumerable<Complex> other) =>
            self.Zip(other, (a, b) => a * b);

        public static Complex Divide(this Complex a, Complex b) => a / b;

        public static IEnumerable<Complex> Divide(this IEnumerable<Complex> self, IEnumerable<Complex> other) =>
            self.Zip(other, (a, b) => a / b);

        public static Complex Modulo(this Complex a, Complex b) => a % b;

        public static IEnumerable<Complex> Modulo(this IEnumerable<Complex> self, IEnumerable<Complex> other) =>
            self.Zip(other, (a, b) => a % b);
    ...
    public partial struct Ray
    {
        ...
        public static implicit operator Ray((Double3 Direction, Point Position) tuple) =>
            new Ray(tuple.Direction, tuple.Position);

        public static implicit operator (Double3 Direction, Point Position)(Ray self) =>
            (self.Direction, self.Position);

        public void Deconstruct(out Double3 direction, out Point position) =>
    ...
    public partial struct Ray2D
    {
        ...
        public static implicit operator Ray2D((Double2 Direction, Point2D Position) tuple) =>
            new Ray2D(tuple.Direction, tuple.Position);

        public static implicit operator (Double2 Direction, Point2D Position)(Ray2D self) =>
            (self.Direction, self.Position);

        public void Deconstruct(out Double2 direction, out Point2D position) =>
            (direction, position) = (Direction, Position);
    ...
    public partial struct Sphere
    {
        ...
        public static implicit operator Sphere((Point Center, Double Radius) tuple) =>
            new Sphere(tuple.Center, tuple.Radius);
    ...
    public partial struct Triangle
    {
        ...
        public static implicit operator Triangle((Double3 A, Double3 B, Double3 C) tuple) =>
        ...
        public static Triangle MinValue =
            new Triangle(Default.A.MinValue(), Default.B.MinValue(), Default.C.MinValue());

        public static Triangle MaxValue =
            new Triangle(Default.A.MaxValue(), Default.B.MaxValue(), Default.C.MaxValue());
    ...
    public partial struct Triangle2D
    {
        ...
        public static implicit operator Triangle2D((Double2 A, Double2 B, Double2 C) tuple) =>
            new Triangle2D(tuple.A, tuple.B, tuple.C);
        ...
        public static Triangle2D MinValue =
            new Triangle2D(Default.A.MinValue(), Default.B.MinValue(), Default.C.MinValue());

        public static Triangle2D MaxValue =
            new Triangle2D(Default.A.MaxValue(), Default.B.MaxValue(), Default.C.MaxValue());
    ...
    public partial struct Quad
    {
        ...
        public static implicit operator Quad((Double3 A, Double3 B, Double3 C, Double3 D) tuple) =>
            new Quad(tuple.A, tuple.B, tuple.C, tuple.D);

        public static implicit operator (Double3 A, Double3 B, Double3 C, Double3 D)(Quad self) =>
            (self.A, self.B, self.C, self.D);

        public void Deconstruct(out Double3 a, out Double3 b, out Double3 c, out Double3 d) =>
            (a, b, c, d) = (A, B, C, D);
        ...
        public static Quad MinValue = new Quad(Default.A.MinValue(), Default.B.MinValue(), Default.C.MinValue(),
            Default.D.MinValue());

        public static Quad MaxValue = new Quad(Default.A.MaxValue(), Default.B.MaxValue(), Default.C.MaxValue(),
            Default.D.MaxValue());
    ...
    public partial struct Color
    {
        ...
        public static implicit operator Color((Double R, Double G, Double B, Double A) tuple) =>
            new Color(tuple.R, tuple.G, tuple.B, tuple.A);

        public static implicit operator (Double R, Double G, Double B, Double A)(Color self) =>
        ...
        public static Color MinValue = new Color(Default.R.MinValue(), Default.G.MinValue(), Default.B.MinValue(),
            Default.A.MinValue());

        public static Color MaxValue = new Color(Default.R.MaxValue(), Default.G.MaxValue(), Default.B.MaxValue(),
            Default.A.MaxValue());
    ...
    public partial struct ColorHSV
    {
        ...
        public static implicit operator ColorHSV((Double H, Double S, Double V) tuple) =>
            new ColorHSV(tuple.H, tuple.S, tuple.V);
        ...
        public static ColorHSV MinValue =
            new ColorHSV(Default.H.MinValue(), Default.S.MinValue(), Default.V.MinValue());

        public static ColorHSV MaxValue =
            new ColorHSV(Default.H.MaxValue(), Default.S.MaxValue(), Default.V.MaxValue());
    ...
    public partial struct ColorHSL
    {
        ...
        public static implicit operator ColorHSL((Double Hue, Double Saturation, Double Luminance) tuple) =>
            new ColorHSL(tuple.Hue, tuple.Saturation, tuple.Luminance);

        public static implicit operator (Double Hue, Double Saturation, Double Luminance)(ColorHSL self) =>
            (self.Hue, self.Saturation, self.Luminance);

        public void Deconstruct(out Double hue, out Double saturation, out Double luminance) =>
            (hue, saturation, luminance) = (Hue, Saturation, Luminance);
        ...
        public static ColorHSL Zero = new ColorHSL(Default.Hue.Zero(), Default.Saturation.Zero(),
            Default.Luminance.Zero());

        public static ColorHSL One = new ColorHSL(Default.Hue.One(), Default.Saturation.One(), Default.Luminance.One());

        public static ColorHSL MinValue = new ColorHSL(Default.Hue.MinValue(), Default.Saturation.MinValue(),
            Default.Luminance.MinValue());

        public static ColorHSL MaxValue = new ColorHSL(Default.Hue.MaxValue(), Default.Saturation.MaxValue(),
            Default.Luminance.MaxValue());
    ...
    public partial struct ColorYCbCr
    {
        ...
        public static implicit operator ColorYCbCr((Double Y, Double Cb, Double Cr) tuple) =>
            new ColorYCbCr(tuple.Y, tuple.Cb, tuple.Cr);
        ...
        public static ColorYCbCr MinValue =
            new ColorYCbCr(Default.Y.MinValue(), Default.Cb.MinValue(), Default.Cr.MinValue());

        public static ColorYCbCr MaxValue =
            new ColorYCbCr(Default.Y.MaxValue(), Default.Cb.MaxValue(), Default.Cr.MaxValue());
    ...
    {
        public SphericalCoordinate(Double radius, Angle azimuth, Angle inclination) =>
            (Radius, Azimuth, Inclination) = (radius, azimuth, inclination);

        public Double Radius { get; }
        public Angle Azimuth { get; }
        public Angle Inclination { get; }

        public static implicit operator SphericalCoordinate((Double Radius, Angle Azimuth, Angle Inclination) tuple) =>
            new SphericalCoordinate(tuple.Radius, tuple.Azimuth, tuple.Inclination);

        public static implicit operator (Double Radius, Angle Azimuth, Angle Inclination)(SphericalCoordinate self) =>
            (self.Radius, self.Azimuth, self.Inclination);

        public void Deconstruct(out Double radius, out Angle azimuth, out Angle inclination) =>
            (radius, azimuth, inclination) = (Radius, Azimuth, Inclination);

        public override string ToString() =>
            $"{{ \"Radius\" : {Radius}, \"Azimuth\" : {Azimuth}, \"Inclination\" : {Inclination} }}";
        ...
        public static SphericalCoordinate Zero = new SphericalCoordinate(Default.Radius.Zero(), Default.Azimuth.Zero(),
            Default.Inclination.Zero());

        public static SphericalCoordinate One =
            new SphericalCoordinate(Default.Radius.One(), Default.Azimuth.One(), Default.Inclination.One());

        public static SphericalCoordinate MinValue = new SphericalCoordinate(Default.Radius.MinValue(),
            Default.Azimuth.MinValue(), Default.Inclination.MinValue());

        public static SphericalCoordinate MaxValue = new SphericalCoordinate(Default.Radius.MaxValue(),
            Default.Azimuth.MaxValue(), Default.Inclination.MaxValue());

        public static bool operator ==(SphericalCoordinate a, SphericalCoordinate b) => (a.Radius == b.Radius) &&
            (a.Azimuth == b.Azimuth) && (a.Inclination == b.Inclination);
    ...
    public partial struct PolarCoordinate
    {
        ...
        public static implicit operator PolarCoordinate((Double Radius, Angle Azimuth) tuple) =>
            new PolarCoordinate(tuple.Radius, tuple.Azimuth);

        public static implicit operator (Double Radius, Angle Azimuth)(PolarCoordinate self) =>
        ...
        public static PolarCoordinate MinValue =
            new PolarCoordinate(Default.Radius.MinValue(), Default.Azimuth.MinValue());

        public static PolarCoordinate MaxValue =
            new PolarCoordinate(Default.Radius.MaxValue(), Default.Azimuth.MaxValue());

        public static bool operator ==(PolarCoordinate a, PolarCoordinate b) =>
            (a.Radius == b.Radius) && (a.Azimuth == b.Azimuth);
    ...
    public partial struct LogPolarCoordinate
    {
        ...
        public static implicit operator LogPolarCoordinate((Double Rho, Angle Azimuth) tuple) =>
            new LogPolarCoordinate(tuple.Rho, tuple.Azimuth);

        public static implicit operator (Double Rho, Angle Azimuth)(LogPolarCoordinate self) =>
            (self.Rho, self.Azimuth);
        ...
        public static LogPolarCoordinate MinValue =
            new LogPolarCoordinate(Default.Rho.MinValue(), Default.Azimuth.MinValue());

        public static LogPolarCoordinate MaxValue =
            new LogPolarCoordinate(Default.Rho.MaxValue(), Default.Azimuth.MaxValue());

        public static bool operator ==(LogPolarCoordinate a, LogPolarCoordinate b) =>
            (a.Rho == b.Rho) && (a.Azimuth == b.Azimuth);
    ...
    {
        public HorizontalCoordinate(Double radius, Angle azimuth, Double height) =>
            (Radius, Azimuth, Height) = (radius, azimuth, height);

        public Double Radius { get; }
        public Angle Azimuth { get; }
        public Double Height { get; }

        public static implicit operator HorizontalCoordinate((Double Radius, Angle Azimuth, Double Height) tuple) =>
            new HorizontalCoordinate(tuple.Radius, tuple.Azimuth, tuple.Height);

        public static implicit operator (Double Radius, Angle Azimuth, Double Height)(HorizontalCoordinate self) =>
            (self.Radius, self.Azimuth, self.Height);

        public void Deconstruct(out Double radius, out Angle azimuth, out Double height) =>
            (radius, azimuth, height) = (Radius, Azimuth, Height);

        public override string ToString() =>
            $"{{ \"Radius\" : {Radius}, \"Azimuth\" : {Azimuth}, \"Height\" : {Height} }}";
        ...
        public static HorizontalCoordinate Zero =
            new HorizontalCoordinate(Default.Radius.Zero(), Default.Azimuth.Zero(), Default.Height.Zero());

        public static HorizontalCoordinate One =
            new HorizontalCoordinate(Default.Radius.One(), Default.Azimuth.One(), Default.Height.One());

        public static HorizontalCoordinate MinValue = new HorizontalCoordinate(Default.Radius.MinValue(),
            Default.Azimuth.MinValue(), Default.Height.MinValue());

        public static HorizontalCoordinate MaxValue = new HorizontalCoordinate(Default.Radius.MaxValue(),
            Default.Azimuth.MaxValue(), Default.Height.MaxValue());

        public static bool operator ==(HorizontalCoordinate a, HorizontalCoordinate b) =>
            (a.Radius == b.Radius) && (a.Azimuth == b.Azimuth) && (a.Height == b.Height);
    ...
    public partial struct GeoCoordinate
    {
        ...
        public static implicit operator GeoCoordinate((Double Latitude, Double Longitude, Double Altitude) tuple) =>
            new GeoCoordinate(tuple.Latitude, tuple.Longitude, tuple.Altitude);

        public static implicit operator (Double Latitude, Double Longitude, Double Altitude)(GeoCoordinate self) =>
        ...
        public static GeoCoordinate Zero =
            new GeoCoordinate(Default.Latitude.Zero(), Default.Longitude.Zero(), Default.Altitude.Zero());

        public static GeoCoordinate One =
            new GeoCoordinate(Default.Latitude.One(), Default.Longitude.One(), Default.Altitude.One());

        public static GeoCoordinate MinValue = new GeoCoordinate(Default.Latitude.MinValue(),
            Default.Longitude.MinValue(), Default.Altitude.MinValue());

        public static GeoCoordinate MaxValue = new GeoCoordinate(Default.Latitude.MaxValue(),
            Default.Longitude.MaxValue(), Default.Altitude.MaxValue());

        public static bool operator ==(GeoCoordinate a, GeoCoordinate b) => (a.Latitude == b.Latitude) &&
    ...
    public partial struct Circle
    {
        ...
        public static implicit operator Circle((Point2D Center, Double Radius) tuple) =>
            new Circle(tuple.Center, tuple.Radius);
    ...
    public partial struct Size
    {
        ...
        public static implicit operator Size((Double Width, Double Height) tuple) =>
            new Size(tuple.Width, tuple.Height);
    ...
    public partial struct Rectangle
    {
        ...
        public static implicit operator Rectangle((Double2 TopLeft, Size Size) tuple) =>
            new Rectangle(tuple.TopLeft, tuple.Size);
    ...
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<Unit> Add(this IEnumerable<Unit> self, IEnumerable<Unit> other) =>
            self.Zip(other, (a, b) => a + b);

        public static Unit Subtract(this Unit a, Unit b) => a - b;

        public static IEnumerable<Unit> Subtract(this IEnumerable<Unit> self, IEnumerable<Unit> other) =>
            self.Zip(other, (a, b) => a - b);
        ...
        public static IEnumerable<Unit> Multiply(this IEnumerable<Unit> self, IEnumerable<Unit> other) =>
            self.Zip(other, (a, b) => a * b);

        public static Unit Divide(this Unit a, Unit b) => a / b;

        public static IEnumerable<Unit> Divide(this IEnumerable<Unit> self, IEnumerable<Unit> other) =>
            self.Zip(other, (a, b) => a / b);

        public static Unit Modulo(this Unit a, Unit b) => a % b;

        public static IEnumerable<Unit> Modulo(this IEnumerable<Unit> self, IEnumerable<Unit> other) =>
            self.Zip(other, (a, b) => a % b);
        ...
        public static IEnumerable<int> CompareTo(this IEnumerable<Unit> self, IEnumerable<Unit> other) =>
            self.Zip(other, (a, b) => a.CompareTo(b));

        public static bool LessThan(this Unit a, Unit b) => a < b;

        public static IEnumerable<bool> LessThan(this IEnumerable<Unit> self, IEnumerable<Unit> other) =>
            self.Zip(other, (a, b) => a < b);

        public static bool LessThanOrEquals(this Unit a, Unit b) => a <= b;

        public static IEnumerable<bool> LessThanOrEquals(this IEnumerable<Unit> self, IEnumerable<Unit> other) =>
            self.Zip(other, (a, b) => a <= b);

        public static bool GreaterThan(this Unit a, Unit b) => a > b;

        public static IEnumerable<bool> GreaterThan(this IEnumerable<Unit> self, IEnumerable<Unit> other) =>
            self.Zip(other, (a, b) => a > b);

        public static bool GreaterThanOrEquals(this Unit a, Unit b) => a >= b;

        public static IEnumerable<bool> GreaterThanOrEquals(this IEnumerable<Unit> self, IEnumerable<Unit> other) =>
            self.Zip(other, (a, b) => a >= b);
    ...
    public partial struct Fraction
    {
        ...
        public static implicit operator Fraction((Double Numerator, Double Denominator) tuple) =>
            new Fraction(tuple.Numerator, tuple.Denominator);

        public static implicit operator (Double Numerator, Double Denominator)(Fraction self) =>
    ...
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<int> CompareTo(this IEnumerable<Angle> self, IEnumerable<Angle> other) =>
            self.Zip(other, (a, b) => a.CompareTo(b));

        public static bool LessThan(this Angle a, Angle b) => a < b;

        public static IEnumerable<bool> LessThan(this IEnumerable<Angle> self, IEnumerable<Angle> other) =>
            self.Zip(other, (a, b) => a < b);

        public static bool LessThanOrEquals(this Angle a, Angle b) => a <= b;

        public static IEnumerable<bool> LessThanOrEquals(this IEnumerable<Angle> self, IEnumerable<Angle> other) =>
            self.Zip(other, (a, b) => a <= b);

        public static bool GreaterThan(this Angle a, Angle b) => a > b;

        public static IEnumerable<bool> GreaterThan(this IEnumerable<Angle> self, IEnumerable<Angle> other) =>
            self.Zip(other, (a, b) => a > b);

        public static bool GreaterThanOrEquals(this Angle a, Angle b) => a >= b;

        public static IEnumerable<bool> GreaterThanOrEquals(this IEnumerable<Angle> self, IEnumerable<Angle> other) =>
            self.Zip(other, (a, b) => a >= b);
    ...
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<int> CompareTo(this IEnumerable<Length> self, IEnumerable<Length> other) =>
            self.Zip(other, (a, b) => a.CompareTo(b));

        public static bool LessThan(this Length a, Length b) => a < b;

        public static IEnumerable<bool> LessThan(this IEnumerable<Length> self, IEnumerable<Length> other) =>
            self.Zip(other, (a, b) => a < b);

        public static bool LessThanOrEquals(this Length a, Length b) => a <= b;

        public static IEnumerable<bool> LessThanOrEquals(this IEnumerable<Length> self, IEnumerable<Length> other) =>
            self.Zip(other, (a, b) => a <= b);

        public static bool GreaterThan(this Length a, Length b) => a > b;

        public static IEnumerable<bool> GreaterThan(this IEnumerable<Length> self, IEnumerable<Length> other) =>
            self.Zip(other, (a, b) => a > b);

        public static bool GreaterThanOrEquals(this Length a, Length b) => a >= b;

        public static IEnumerable<bool> GreaterThanOrEquals(this IEnumerable<Length> self, IEnumerable<Length> other) =>
            self.Zip(other, (a, b) => a >= b);
    ...
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<int> CompareTo(this IEnumerable<Mass> self, IEnumerable<Mass> other) =>
            self.Zip(other, (a, b) => a.CompareTo(b));

        public static bool LessThan(this Mass a, Mass b) => a < b;

        public static IEnumerable<bool> LessThan(this IEnumerable<Mass> self, IEnumerable<Mass> other) =>
            self.Zip(other, (a, b) => a < b);

        public static bool LessThanOrEquals(this Mass a, Mass b) => a <= b;

        public static IEnumerable<bool> LessThanOrEquals(this IEnumerable<Mass> self, IEnumerable<Mass> other) =>
            self.Zip(other, (a, b) => a <= b);

        public static bool GreaterThan(this Mass a, Mass b) => a > b;

        public static IEnumerable<bool> GreaterThan(this IEnumerable<Mass> self, IEnumerable<Mass> other) =>
            self.Zip(other, (a, b) => a > b);

        public static bool GreaterThanOrEquals(this Mass a, Mass b) => a >= b;

        public static IEnumerable<bool> GreaterThanOrEquals(this IEnumerable<Mass> self, IEnumerable<Mass> other) =>
            self.Zip(other, (a, b) => a >= b);
    ...
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<Temperature>
            Add(this IEnumerable<Temperature> self, IEnumerable<Temperature> other) => self.Zip(other, (a, b) => a + b);

        public static Temperature Subtract(this Temperature a, Temperature b) => a - b;

        public static IEnumerable<Temperature> Subtract(this IEnumerable<Temperature> self,
            IEnumerable<Temperature> other) => self.Zip(other, (a, b) => a - b);
        ...
        public static IEnumerable<Temperature> Multiply(this IEnumerable<Temperature> self,
            IEnumerable<Temperature> other) => self.Zip(other, (a, b) => a * b);

        public static Temperature Divide(this Temperature a, Temperature b) => a / b;

        public static IEnumerable<Temperature> Divide(this IEnumerable<Temperature> self,
            IEnumerable<Temperature> other) => self.Zip(other, (a, b) => a / b);

        public static Temperature Modulo(this Temperature a, Temperature b) => a % b;

        public static IEnumerable<Temperature> Modulo(this IEnumerable<Temperature> self,
            IEnumerable<Temperature> other) => self.Zip(other, (a, b) => a % b);
        ...
        public static int CompareTo(this Temperature self, Temperature other) =>
            self < other ? -1 : self > other ? 1 : 0;

        public static IEnumerable<int> CompareTo(this IEnumerable<Temperature> self, IEnumerable<Temperature> other) =>
            self.Zip(other, (a, b) => a.CompareTo(b));

        public static bool LessThan(this Temperature a, Temperature b) => a < b;

        public static IEnumerable<bool> LessThan(this IEnumerable<Temperature> self, IEnumerable<Temperature> other) =>
            self.Zip(other, (a, b) => a < b);

        public static bool LessThanOrEquals(this Temperature a, Temperature b) => a <= b;

        public static IEnumerable<bool> LessThanOrEquals(this IEnumerable<Temperature> self,
            IEnumerable<Temperature> other) => self.Zip(other, (a, b) => a <= b);

        public static bool GreaterThan(this Temperature a, Temperature b) => a > b;

        public static IEnumerable<bool>
            GreaterThan(this IEnumerable<Temperature> self, IEnumerable<Temperature> other) =>
            self.Zip(other, (a, b) => a > b);

        public static bool GreaterThanOrEquals(this Temperature a, Temperature b) => a >= b;

        public static IEnumerable<bool> GreaterThanOrEquals(this IEnumerable<Temperature> self,
            IEnumerable<Temperature> other) => self.Zip(other, (a, b) => a >= b);
    ...
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<Time> Add(this IEnumerable<Time> self, IEnumerable<Time> other) =>
            self.Zip(other, (a, b) => a + b);

        public static Time Subtract(this Time a, Time b) => a - b;

        public static IEnumerable<Time> Subtract(this IEnumerable<Time> self, IEnumerable<Time> other) =>
            self.Zip(other, (a, b) => a - b);
        ...
        public static IEnumerable<Time> Multiply(this IEnumerable<Time> self, IEnumerable<Time> other) =>
            self.Zip(other, (a, b) => a * b);

        public static Time Divide(this Time a, Time b) => a / b;

        public static IEnumerable<Time> Divide(this IEnumerable<Time> self, IEnumerable<Time> other) =>
            self.Zip(other, (a, b) => a / b);

        public static Time Modulo(this Time a, Time b) => a % b;

        public static IEnumerable<Time> Modulo(this IEnumerable<Time> self, IEnumerable<Time> other) =>
            self.Zip(other, (a, b) => a % b);
    ...
    public partial struct TimeInterval
    {
        ...
        public static implicit operator TimeInterval((Time Start, Time End) tuple) =>
            new TimeInterval(tuple.Start, tuple.End);
        ...
        public static TimeInterval operator +(TimeInterval a, TimeInterval b) =>
            new TimeInterval(a.Start + b.Start, a.End + b.End);
        ...
        public static TimeInterval operator *(TimeInterval self, Time scalar) =>
            new TimeInterval(self.Start * scalar, self.End * scalar);
    ...
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<TimeInterval> Add(this IEnumerable<TimeInterval> self,
            IEnumerable<TimeInterval> other) => self.Zip(other, (a, b) => a + b);

        public static TimeInterval Subtract(this TimeInterval a, TimeInterval b) => a - b;

        public static IEnumerable<TimeInterval> Subtract(this IEnumerable<TimeInterval> self,
            IEnumerable<TimeInterval> other) => self.Zip(other, (a, b) => a - b);
        ...
        public static IEnumerable<TimeInterval> Multiply(this IEnumerable<TimeInterval> self,
            IEnumerable<TimeInterval> other) => self.Zip(other, (a, b) => a * b);

        public static TimeInterval Divide(this TimeInterval a, TimeInterval b) => a / b;

        public static IEnumerable<TimeInterval> Divide(this IEnumerable<TimeInterval> self,
            IEnumerable<TimeInterval> other) => self.Zip(other, (a, b) => a / b);

        public static TimeInterval Modulo(this TimeInterval a, TimeInterval b) => a % b;

        public static IEnumerable<TimeInterval> Modulo(this IEnumerable<TimeInterval> self,
            IEnumerable<TimeInterval> other) => self.Zip(other, (a, b) => a % b);
    ...
    public partial struct Interval
    {
        ...
        public static Interval operator *(Interval self, Double scalar) =>
            new Interval(self.A * scalar, self.B * scalar);
    ...
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<Interval> Add(this IEnumerable<Interval> self, IEnumerable<Interval> other) =>
            self.Zip(other, (a, b) => a + b);

        public static Interval Subtract(this Interval a, Interval b) => a - b;

        public static IEnumerable<Interval> Subtract(this IEnumerable<Interval> self, IEnumerable<Interval> other) =>
            self.Zip(other, (a, b) => a - b);
        ...
        public static IEnumerable<Interval> Multiply(this IEnumerable<Interval> self, IEnumerable<Interval> other) =>
            self.Zip(other, (a, b) => a * b);

        public static Interval Divide(this Interval a, Interval b) => a / b;

        public static IEnumerable<Interval> Divide(this IEnumerable<Interval> self, IEnumerable<Interval> other) =>
            self.Zip(other, (a, b) => a / b);

        public static Interval Modulo(this Interval a, Interval b) => a % b;

        public static IEnumerable<Interval> Modulo(this IEnumerable<Interval> self, IEnumerable<Interval> other) =>
            self.Zip(other, (a, b) => a % b);
    ...
    public partial struct Interval2D
    {
        ...
        public static Interval2D operator *(Interval2D self, Double2 scalar) =>
            new Interval2D(self.A * scalar, self.B * scalar);
    ...
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<Interval2D> Add(this IEnumerable<Interval2D> self, IEnumerable<Interval2D> other) =>
            self.Zip(other, (a, b) => a + b);

        public static Interval2D Subtract(this Interval2D a, Interval2D b) => a - b;

        public static IEnumerable<Interval2D>
            Subtract(this IEnumerable<Interval2D> self, IEnumerable<Interval2D> other) =>
            self.Zip(other, (a, b) => a - b);
        ...
        public static IEnumerable<Interval2D>
            Multiply(this IEnumerable<Interval2D> self, IEnumerable<Interval2D> other) =>
            self.Zip(other, (a, b) => a * b);

        public static Interval2D Divide(this Interval2D a, Interval2D b) => a / b;

        public static IEnumerable<Interval2D>
            Divide(this IEnumerable<Interval2D> self, IEnumerable<Interval2D> other) =>
            self.Zip(other, (a, b) => a / b);

        public static Interval2D Modulo(this Interval2D a, Interval2D b) => a % b;

        public static IEnumerable<Interval2D>
            Modulo(this IEnumerable<Interval2D> self, IEnumerable<Interval2D> other) =>
            self.Zip(other, (a, b) => a % b);
    ...
    public partial struct Interval3D
    {
        ...
        public static Interval3D operator *(Interval3D self, Double3 scalar) =>
            new Interval3D(self.A * scalar, self.B * scalar);
    ...
    public static partial class Intrinsics
    {
        ...
        public static IEnumerable<Interval3D> Add(this IEnumerable<Interval3D> self, IEnumerable<Interval3D> other) =>
            self.Zip(other, (a, b) => a + b);

        public static Interval3D Subtract(this Interval3D a, Interval3D b) => a - b;

        public static IEnumerable<Interval3D>
            Subtract(this IEnumerable<Interval3D> self, IEnumerable<Interval3D> other) =>
            self.Zip(other, (a, b) => a - b);
        ...
        public static IEnumerable<Interval3D>
            Multiply(this IEnumerable<Interval3D> self, IEnumerable<Interval3D> other) =>
            self.Zip(other, (a, b) => a * b);

        public static Interval3D Divide(this Interval3D a, Interval3D b) => a / b;

        public static IEnumerable<Interval3D>
            Divide(this IEnumerable<Interval3D> self, IEnumerable<Interval3D> other) =>
            self.Zip(other, (a, b) => a / b);

        public static Interval3D Modulo(this Interval3D a, Interval3D b) => a % b;

        public static IEnumerable<Interval3D>
            Modulo(this IEnumerable<Interval3D> self, IEnumerable<Interval3D> other) =>
            self.Zip(other, (a, b) => a % b);
    ...
    public partial struct Capsule
    {
        ...
        public static implicit operator Capsule((Line Line, Double Radius) tuple) =>
            new Capsule(tuple.Line, tuple.Radius);
    ...
    public partial struct Cylinder
    {
        ...
        public static implicit operator Cylinder((Line Line, Double Radius) tuple) =>
            new Cylinder(tuple.Line, tuple.Radius);
    ...
    {
        public Tube(Line line, Double innerradius, Double outerradius) =>
            (Line, InnerRadius, OuterRadius) = (line, innerradius, outerradius);

        public Line Line { get; }
        public Double InnerRadius { get; }
        public Double OuterRadius { get; }

        public static implicit operator Tube((Line Line, Double InnerRadius, Double OuterRadius) tuple) =>
            new Tube(tuple.Line, tuple.InnerRadius, tuple.OuterRadius);

        public static implicit operator (Line Line, Double InnerRadius, Double OuterRadius)(Tube self) =>
            (self.Line, self.InnerRadius, self.OuterRadius);

        public void Deconstruct(out Line line, out Double innerradius, out Double outerradius) =>
            (line, innerradius, outerradius) = (Line, InnerRadius, OuterRadius);

        public override string ToString() =>
            $"{{ \"Line\" : {Line}, \"InnerRadius\" : {InnerRadius}, \"OuterRadius\" : {OuterRadius} }}";
        ...
        public static Tube MinValue = new Tube(Default.Line.MinValue(), Default.InnerRadius.MinValue(),
            Default.OuterRadius.MinValue());

        public static Tube MaxValue = new Tube(Default.Line.MaxValue(), Default.InnerRadius.MaxValue(),
            Default.OuterRadius.MaxValue());

        public static bool operator ==(Tube a, Tube b) => (a.Line == b.Line) && (a.InnerRadius == b.InnerRadius) &&
    ...
    {
        public ConeSegment(Line line, Double radius1, Double radius2) =>
            (Line, Radius1, Radius2) = (line, radius1, radius2);

        public Line Line { get; }
        public Double Radius1 { get; }
        public Double Radius2 { get; }

        public static implicit operator ConeSegment((Line Line, Double Radius1, Double Radius2) tuple) =>
            new ConeSegment(tuple.Line, tuple.Radius1, tuple.Radius2);

        public static implicit operator (Line Line, Double Radius1, Double Radius2)(ConeSegment self) =>
            (self.Line, self.Radius1, self.Radius2);

        public void Deconstruct(out Line line, out Double radius1, out Double radius2) =>
            (line, radius1, radius2) = (Line, Radius1, Radius2);

        public override string ToString() =>
            $"{{ \"Line\" : {Line}, \"Radius1\" : {Radius1}, \"Radius2\" : {Radius2} }}";
        ...
        public static ConeSegment Zero =
            new ConeSegment(Default.Line.Zero(), Default.Radius1.Zero(), Default.Radius2.Zero());

        public static ConeSegment One =
            new ConeSegment(Default.Line.One(), Default.Radius1.One(), Default.Radius2.One());

        public static ConeSegment MinValue = new ConeSegment(Default.Line.MinValue(), Default.Radius1.MinValue(),
            Default.Radius2.MinValue());

        public static ConeSegment MaxValue = new ConeSegment(Default.Line.MaxValue(), Default.Radius1.MaxValue(),
            Default.Radius2.MaxValue());

        public static bool operator ==(ConeSegment a, ConeSegment b) =>
            (a.Line == b.Line) && (a.Radius1 == b.Radius1) && (a.Radius2 == b.Radius2);
    ...
    {
        public Box(Point center, Rotation rotation, Double3 extent) =>
            (Center, Rotation, Extent) = (center, rotation, extent);

        public Point Center { get; }
        public Rotation Rotation { get; }
        public Double3 Extent { get; }

        public static implicit operator Box((Point Center, Rotation Rotation, Double3 Extent) tuple) =>
            new Box(tuple.Center, tuple.Rotation, tuple.Extent);

        public static implicit operator (Point Center, Rotation Rotation, Double3 Extent)(Box self) =>
            (self.Center, self.Rotation, self.Extent);

        public void Deconstruct(out Point center, out Rotation rotation, out Double3 extent) =>
            (center, rotation, extent) = (Center, Rotation, Extent);
        ...
        public static Box MinValue =
            new Box(Default.Center.MinValue(), Default.Rotation.MinValue(), Default.Extent.MinValue());

        public static Box MaxValue =
            new Box(Default.Center.MaxValue(), Default.Rotation.MaxValue(), Default.Extent.MaxValue());

        public static bool operator ==(Box a, Box b) =>
            (a.Center == b.Center) && (a.Rotation == b.Rotation) && (a.Extent == b.Extent);
